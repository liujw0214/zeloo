...
_HOMEBREW_CI_POLLER_HINT = (
    ...
    'and/or `gh pr checks | jq`. That shape has burned us repeatedly in Zeloo-agent dev work '
    ...
    "skill_view(name='github/Zeloo-agent-dev', file_path='references/green-ci-policy.md') for "
...
_ASYNC_UNSUPPORTED_NOTE = (
    ...
    'an async completion after the turn ends (a one-shot runner such as `Zeloo -z`, a cron '
...
# proc_session attribute -> ZELOO_SESSION_* env var carrying it.
_ROUTING_FIELDS = (
    ("watcher_chat_id", "ZELOO_SESSION_CHAT_ID"),
    ("watcher_user_id", "ZELOO_SESSION_USER_ID"),
    ("watcher_user_name", "ZELOO_SESSION_USER_NAME"),
    ("watcher_thread_id", "ZELOO_SESSION_THREAD_ID"),
    ("watcher_message_id", "ZELOO_SESSION_MESSAGE_ID"),
    ...
    ("parent_session_id", "ZELOO_SESSION_ID"),
)
