...
# containing `cat ~/.Zeloo/.env` or `rm -rf /`; there it is a smoking gun, not prose.
...
# `Zeloo-agent-dev` skill contains a security postmortem mentioning `cat ~/.Zeloo/.env`, which tripped
