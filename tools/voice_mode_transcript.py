...
# is treated as a self-capture of Zeloo' own TTS: the full-duplex listener has no echo
...
def is_tts_echo(transcript: str, spoken_text: str,
    ...
    (language-agnostic): a genuine interjection rarely matches Zeloo' own words, so a high ratio signals
