...
DIALOG_BRIDGE_HOST = "Zeloo-dialog-bridge.invalid"
...
(() => {
  if (window.__ZELOODialogBridgeInstalled) return;
  window.__ZELOODialogBridgeInstalled = true;
  const ENDPOINT = "http://Zeloo-dialog-bridge.invalid/";
