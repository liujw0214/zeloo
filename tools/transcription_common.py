...
LOCAL_STT_COMMAND_ENV = "ZELOO_LOCAL_STT_COMMAND"
LOCAL_STT_LANGUAGE_ENV = "ZELOO_LOCAL_STT_LANGUAGE"
...
# DeepInfra STT base URL is resolved via zeloo_cli.models.deepinfra_base_url (shared).
