...
def _transcribe_local_command(
    ...
    try:
        with tempfile.TemporaryDirectory(prefix="Zeloo-local-stt-") as output_dir:
            ...
            # Scrub Zeloo secrets from the child env (same policy as _run_command_stt).
            # Scrub Zeloo secrets from the child env (sibling path to #56332 / _run_command_stt — this
            ...
            _run_quiet(shlex.split(command), timeout=300, env=zeloo_subprocess_env(inherit_credentials=False))
