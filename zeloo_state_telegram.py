"""Telegram DM topic-mode mixin for :class:`zeloo_state.SessionDB`."""
...
from zeloo_state_common import _PREVIEW_ELIGIBLE_SQL, _PREVIEW_RAW_SELECT, _sql_session_last_active
...
class SessionTelegramTopicsMixin:
    ...
    def bind_telegram_topic(
        ...
        """Bind one Telegram DM topic thread to one Zeloo session. A session may be linked to
