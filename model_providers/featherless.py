"""Featherless provider — managed open AI inference."""
...
@dataclass
class FeatherlessProvider(ProviderProfile):
    """Featherless AI inference provider.

    Provides managed inference for open-source models at competitive pricing.
