"""Anyscale provider — managed endpoints for open-source models."""
...
@dataclass
class AnyscaleProvider(ProviderProfile):
    """Anyscale managed inference provider.

    Provides managed endpoints for open-source models.
    ...
    def chat_completion(
        ...
        **kwargs: Any,
        ...
        if not api_key:
            raise ValueError("ANYSCALE_API_KEY environment variable not set")
