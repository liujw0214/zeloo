"""Lepton AI provider — efficient AI inference at low cost."""
...
@dataclass
class LeptonProvider(ProviderProfile):
    """Lepton AI provider.

    Provides fast, cost-effective inference for open-source models.
    OpenAI-compatible API.
    """

    name: str = "lepton"
    base_url: str = "https://api.lepton.ai/v1"
    ...
    def chat_completion(
        ...
        **kwargs: Any,
        ...
        if not api_key:
            raise ValueError("LEPTON_API_KEY environment variable not set")
