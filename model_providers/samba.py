"""SambaNova Cloud provider — fast inference for enterprise."""
...
@dataclass
class SambaNovaProvider(ProviderProfile):
    """SambaNova Cloud inference provider.

    Provides fast GPU-accelerated inference for open-source models
    on SambaNova's AI accelerator chips.
    """
