"""Cohere Command provider — RAG-optimized enterprise models."""
...
@dataclass
class CohereCommandProvider(ProviderProfile):
    """Cohere Command API provider.

    Provides access to Command R+ series models optimized for RAG
    and enterprise use cases.
    """

    name: str = "cohere-command"
