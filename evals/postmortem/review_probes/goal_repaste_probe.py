...
from zeloo_cli import cli_commands_mixin, goals
...
server._zeloo_home = Path(home.name)
...
with patch('zeloo_cli.goals.draft_contract', return_value=None), contextlib.redirect_stdout(io.StringIO()):
