...
os.environ.setdefault("ZELOO_HOME", os.path.expanduser("~/.Zeloo"))  # LIVE: real auxiliary judge calls (cents)
from zeloo_cli import goals
goal = ("Simplify the Zeloo-agent codebase by >=30% LOC with zero behavior change, decomposing every god file, "
