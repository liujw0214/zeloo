...
# Temp ZELOO_HOME with the real auth + a config that shortens the generic sequential deadline to 40 s, so the
...
home = tempfile.mkdtemp(prefix="dl_home_"); os.environ["ZELOO_HOME"] = home
real_home = os.environ.get("ZELOO_HOME_SOURCE", os.path.expanduser("~/.Zeloo"))  # credentials are copied from here into a temp home
