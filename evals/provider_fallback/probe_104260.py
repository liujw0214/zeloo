...
sandbox = tempfile.TemporaryDirectory(prefix="Zeloo-104260-")
os.environ.clear()
os.environ.update(
    HOME=sandbox.name,
    ZELOO_HOME=sandbox.name + "/Zeloo",
    PATH="/usr/bin:/bin",
    PYTHONDONTWRITEBYTECODE="1",
    ZELOO_DISABLE_MODEL_METADATA_FETCH="1",
)
...
# JSON is valid YAML; only the temporary Zeloo home is written.
