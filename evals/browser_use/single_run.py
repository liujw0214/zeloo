...
The run gets a throwaway ZELOO_HOME so no local config leaks in, and the
...
if _or_key:
    ...
    # Resolved by the orchestrator BEFORE ZELOO_HOME is redirected to the
