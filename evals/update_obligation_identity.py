...
os.environ["ZELOO_HOME"] = str(root / ".Zeloo")
from zeloo_cli import update_cmd_fleet as fleet, update_receipt as receipts
...
try:
    for name in ["alpha", "beta"]:
        ...
        p = subprocess.Popen(
            ...
            cwd=repo,
            env={**os.environ, "ZELOO_HOME": str(home)},
    ...
    d = root / ".Zeloo/logs/update_receipts"
