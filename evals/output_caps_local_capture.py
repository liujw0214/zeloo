...
Run from a checkout with ZELOO_HOME pointing to a disposable directory.
"""
import json
import os
...
os.environ["ZELOO_MAX_TOKENS"] = "13"
...
from zeloo_cli.moa_config import _normalize_preset
