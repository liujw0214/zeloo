...
benchmarked ten harnesses on hostile-file handling — and whose Zeloo column
...
Every task runs the full Zeloo agent (file + terminal + search toolsets)
...
Rules of engagement (from ZELOObench discipline):
