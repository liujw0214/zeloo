"""Session <-> workspace grouping key (zeloo_state_sessions.workspace_key).

The key is what `Zeloo sessions list --workspace` groups/filters on. It is a
...
import zeloo_state_sessions
from zeloo_state_sessions import workspace_key
