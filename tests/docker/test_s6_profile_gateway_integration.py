...
The unit tests in tests/zeloo_cli/test_service_manager.py exercise the
...
docstring. ``/run/service`` is chowned Zeloo-writable by the
...
_REGISTER_SCRIPT = """
import sys
sys.path.insert(0, "/opt/Zeloo")
from zeloo_cli.service_manager import S6ServiceManager
