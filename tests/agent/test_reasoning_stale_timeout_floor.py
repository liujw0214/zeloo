...
thinking phase.  Zeloo's default cloud-stream stale detector
(``ZELOO_STREAM_STALE_TIMEOUT`` = 180s) and non-stream detector
(``ZELOO_API_CALL_STALE_TIMEOUT`` = 90s) both fire before the
