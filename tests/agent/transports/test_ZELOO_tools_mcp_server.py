"""Tests for the Zeloo-tools-as-MCP server module surface.
...
from agent.transports.zeloo_tools_mcp_server import (
...
class TestModuleSurface:
    def test_module_imports_clean(self):
        from agent.transports import zeloo_tools_mcp_server as m
...
class TestMain:
    def test_main_returns_2_when_mcp_unavailable(self, monkeypatch):
        ...
        import agent.transports.zeloo_tools_mcp_server as m
