...
* ``zeloo_cli._subprocess_compat.kill_process_tree(proc)`` — also consumed
...
# ---------------------------------------------------------------------------
# (1) zeloo_cli._subprocess_compat.kill_process_tree
# ---------------------------------------------------------------------------
...
def test_e2e_setsid_grandchild_killed_via_compat_wrapper(tmp_path):
    ...
    from zeloo_cli._subprocess_compat import kill_process_tree
