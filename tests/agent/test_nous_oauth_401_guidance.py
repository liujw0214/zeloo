...
to a generic "Your API key was rejected... run Zeloo setup" message, which is
...
def test_nous_401_guidance_strings_present():
    ...
    # Must give a concrete re-auth command, not a generic "Zeloo setup".
    assert "Zeloo portal" in source
