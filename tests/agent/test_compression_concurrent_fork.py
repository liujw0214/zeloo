...
Damien's incident (Discord, 2026-05-28): a long Zeloo session in a Discord
...
def _make_legacy_session_db_class() -> type:
    ...
    imports the same still-loaded ``zeloo_state`` module, whose ``SessionDB``
    ...
    namespace = {"__name__": "zeloo_state"}
    source = '''
class SessionDB:
...
_NominalSessionDBImpostor.__module__ = "zeloo_state"
