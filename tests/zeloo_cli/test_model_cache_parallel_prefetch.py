...
import pytest
from zeloo_cli import model_switch_providers


# ---------------------------------------------------------------------------
# Thread-safe cache entry update (zeloo_cli/models.py)
# ---------------------------------------------------------------------------
...
class TestUpdateProviderCacheEntry:
    ...
    def test_writes_new_entry(self, tmp_path, monkeypatch):
        ...
        import zeloo_cli.models as mod
...
# ---------------------------------------------------------------------------
# Parallel prefetch (zeloo_cli/model_switch.py)
# ---------------------------------------------------------------------------
...
class TestPrefetchProviderModelsParallel:
    ...
    def test_skips_all_fresh_entries(self, monkeypatch):
        ...
        from zeloo_cli.model_switch_providers import _prefetch_provider_models_parallel
        ...
        with patch("zeloo_cli.models._load_provider_models_cache", return_value=fresh_cache), \
             patch("zeloo_cli.models._credential_fingerprint", return_value="fp"), \
             patch("zeloo_cli.models.cached_provider_model_ids") as fetch:
    ...
    def test_fetches_only_stale_entries(self, monkeypatch):
        ...
        with patch("zeloo_cli.models._load_provider_models_cache", return_value=cache), \
             patch("zeloo_cli.models._credential_fingerprint", return_value="fp_f"), \
             patch("zeloo_cli.models.cached_provider_model_ids", side_effect=mock_fetch), \
             patch("zeloo_cli.models.update_provider_cache_entry"):
    ...
    def test_fetches_in_parallel(self, monkeypatch):
        ...
        with patch("zeloo_cli.models._load_provider_models_cache", return_value={}), \
             patch("zeloo_cli.models._credential_fingerprint", return_value="fp"), \
             patch("zeloo_cli.models.cached_provider_model_ids", side_effect=mock_fetch), \
             patch("zeloo_cli.models.update_provider_cache_entry"):
    ...
    def test_empty_list_is_noop(self):
        ...
        with patch("zeloo_cli.models.cached_provider_model_ids") as fetch:
