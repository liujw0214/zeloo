...
class TestGetCopilotModelContext:
    ...
    @patch("zeloo_cli.models.fetch_github_model_catalog", return_value=_SAMPLE_CATALOG)
    ...
    @patch("zeloo_cli.models._urlopen_model_catalog_request")
    ...
    @patch("zeloo_cli.models.fetch_github_model_catalog", return_value=[])
