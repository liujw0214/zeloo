...
def test_vertex_registered_in_provider_registry():
    """PROVIDER_REGISTRY (zeloo_cli.auth) is what agent/auxiliary_client.py's
...
def test_vertex_registered_in_zeloo_overlays():
    """zeloo_cli.providers.get_provider("vertex") backs
