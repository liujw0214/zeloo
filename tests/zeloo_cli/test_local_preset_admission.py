...
from zeloo_cli.local_runtime import presets, supervisor
from zeloo_cli.local_runtime.estimator import HardwareBudget, ModelProfile
...
def test_optional_draft_is_enabled_only_with_room_at_the_selected_window(tmp_path, monkeypatch):
    ...
    from zeloo_cli.local_runtime import bootstrap, catalog
    ...
    from zeloo_cli.local_runtime.estimator import LayerKind, ctx_bytes
