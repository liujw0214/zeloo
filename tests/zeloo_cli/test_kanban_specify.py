"""Tests for the specifier module + `Zeloo kanban specify` CLI surface.
...
from zeloo_cli import kanban as kanban_cli
...
def _run_cli(*argv: str) -> int:
    """Invoke the `Zeloo kanban …` argparse surface directly."""
