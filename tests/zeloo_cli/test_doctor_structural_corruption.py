...
only when every damaged object is a Zeloo FTS shadow.
"""
...
from zeloo_cli.doctor_report import Finding
from zeloo_cli.doctor_state import _state_db_health
from zeloo_state import SessionDB
from zeloo_state_repair import integrity_damage_is_structural, state_db_has_structural_damage
...
def test_doctor_routes_structural_damage_to_recover_not_fts_rebuild(tmp_path, monkeypatch):
    ...
    .malformed-backup, nothing fixed) and must point at `Zeloo sessions recover` for THIS
