"""Tests for `Zeloo secrets bitwarden token` / `Zeloo secrets onepassword token`.
...
from zeloo_cli import onepassword_secrets_cli as op_cli
from zeloo_cli import secrets_cli as bw_cli
