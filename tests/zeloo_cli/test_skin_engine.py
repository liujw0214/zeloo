"""Tests for zeloo_cli.skin_engine — the data-driven skin/theme system."""
...
class TestSkinConfig:
    def test_default_skin_has_required_fields(self):
        from zeloo_cli.skin_engine import load_skin
...
class TestSkinManagement:
    def test_set_active_skin(self):
        from zeloo_cli.skin_engine import set_active_skin, get_active_skin, get_active_skin_name
    ...
    def test_list_skins_includes_builtins(self):
        from zeloo_cli.skin_engine import list_skins
        skins = list_skins()
...
class TestUserSkins:
    def test_load_user_skin_from_yaml(self, tmp_path, monkeypatch):
        ...
        # Patch skins dir
        monkeypatch.setattr("zeloo_cli.skin_engine._skins_dir", lambda: skins_dir)
    ...
    def test_load_user_skin_invalid_section_types_fall_back_to_defaults(self, tmp_path, monkeypatch):
        ...
        assert skin.get_branding("agent_name") == "Zeloo Agent"
...
class TestDisplayIntegration:
    ...
    def test_tool_message_uses_skin_prefix(self):
        from zeloo_cli.skin_engine import set_active_skin
...
class TestCliBrandingHelpers:
    ...
    def test_active_goodbye_ares(self):
        from zeloo_cli.skin_engine import set_active_skin, get_active_goodbye

        set_active_skin("ares")
        assert get_active_goodbye() == "Farewell, warrior! ⚔"

    def test_prompt_toolkit_style_overrides_cover_tui_classes(self):
        from zeloo_cli.skin_engine import set_active_skin, get_prompt_toolkit_style_overrides
        set_active_skin("ares")
