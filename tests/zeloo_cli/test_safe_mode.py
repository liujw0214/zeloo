"""Tests for `Zeloo chat --safe-mode` isolation."""
...
_VARS = ("ZELOO_SAFE_MODE", "ZELOO_IGNORE_USER_CONFIG", "ZELOO_IGNORE_RULES")
...
def test_cmd_chat_safe_mode_sets_env_before_startup(monkeypatch):
    ...
    def fake_has_provider() -> bool:
        assert os.environ["ZELOO_SAFE_MODE"] == "1"
        assert os.environ["ZELOO_IGNORE_USER_CONFIG"] == "1"
        assert os.environ["ZELOO_IGNORE_RULES"] == "1"
        return True
