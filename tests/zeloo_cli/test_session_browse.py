"""Tests for the interactive session browser (`Zeloo sessions browse`).
...
from zeloo_cli.sessions_cmd_browse import _session_browse_picker
...
class TestSessionBrowseArgparse:
    ...
    def test_browse_subcommand_exists(self):
        """Zeloo sessions browse should be parseable."""
