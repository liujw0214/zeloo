"""Tests for the ``Zeloo prompt-size`` diagnostic (issue #34667)."""
...
from zeloo_cli.prompt_size import (
    _SKILLS_BLOCK_RE,
...
def _seed_memory(zeloo_home, memory_text="", user_text=""):
    mem_dir = zeloo_home / "memories"
...
def _seed_skill(zeloo_home, name, description):
    skill_dir = zeloo_home / "skills" / "demo" / name
