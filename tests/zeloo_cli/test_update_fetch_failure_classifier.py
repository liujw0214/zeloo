"""Fetch-failure classification for `Zeloo update` / `Zeloo update --check`.
...
CURL_429_STDERR = (
    "fatal: unable to access 'https://github.com/NousResearch/Zeloo-agent.git/':"
...
def test_update_network_git_calls_never_prompt_for_credentials():
    ...
    Live incident (Sep 2026): a GitHub-side 401 made `Zeloo update` sit on
    ...
    from zeloo_cli import update_cmd_git
