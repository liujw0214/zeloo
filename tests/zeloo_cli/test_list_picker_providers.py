...
import zeloo_cli.model_switch_providers as zeloo_cli_model_switch_providers
...
def test_passthrough_kwargs_to_base(monkeypatch):
    ...
    monkeypatch.setattr(zeloo_cli_model_switch_providers, "list_authenticated_providers", _capture)
    monkeypatch.setattr("zeloo_cli.models.fetch_openrouter_models",
                        lambda *a, **kw: [])
...
def _stub_kimi_discovery(monkeypatch, *, canonical):
    ...
    import zeloo_cli.models as hm
    import zeloo_cli.models_catalog_static as zeloo_cli_models_catalog_static
    from zeloo_cli import models_catalog_static
    ...
    monkeypatch.setattr(zeloo_cli_models_catalog_static, "CANONICAL_PROVIDERS", canonical)
