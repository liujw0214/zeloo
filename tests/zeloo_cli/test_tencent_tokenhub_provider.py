...
# =============================================================================
# CANONICAL_PROVIDERS (Zeloo model picker)
# =============================================================================
...
class TestTencentTokenhubNormalization:
    ...
    def test_not_in_matching_prefix_strip_set(self):
        ...
        copy vendor/ form."""
        from zeloo_cli.model_normalize import _MATCHING_PREFIX_STRIP_PROVIDERS
    ...
    def test_not_in_lowercase_providers(self):
        ...
        from zeloo_cli.model_normalize import _LOWERCASE_MODEL_PROVIDERS
...
class TestTencentTokenhubProvidersModule:
    ...
    def test_overlay_exists(self):
        ...
        assert "tencent-tokenhub" in ZELOO_OVERLAYS
        overlay = ZELOO_OVERLAYS["tencent-tokenhub"]
...
class TestTencentTokenhubAgentInit:
    ...
    def test_api_mode_is_chat_completions(self):
        from zeloo_cli.providers import ZELOO_OVERLAYS, TRANSPORT_TO_API_MODE
        overlay = ZELOO_OVERLAYS["tencent-tokenhub"]
...
class TestTencentTokenhubKnownProviderNames:
    ...
    def test_alias_known(self, alias):
        from zeloo_cli.models import _KNOWN_PROVIDER_NAMES
