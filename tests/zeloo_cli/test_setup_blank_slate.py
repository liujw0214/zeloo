"""Tests for Blank Slate setup mode (zeloo_cli/setup.py).
...
from zeloo_cli.setup_quick import _blank_slate_minimal_toolsets, _blank_slate_minimize_config
