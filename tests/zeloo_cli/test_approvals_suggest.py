"""Tests for ``Zeloo approvals suggest`` (zeloo_cli/approvals_suggest.py).

Approval history in Zeloo is implied, not ledgered: the session DB
...
from zeloo_cli.approvals_suggest import (
    Proposal,
    apply_proposals,
    build_proposals,
    derive_glob,
