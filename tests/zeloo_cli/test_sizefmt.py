"""Tests for the shared byte formatter (zeloo_cli.sizefmt).
...
def test_migrated_sites_render_through_the_shared_helper():
    ...
    from zeloo_cli.backup import _format_size as backup
    from zeloo_cli.checkpoints import _fmt_bytes as checkpoints
    from zeloo_cli.sizefmt import format_bytes as doctor
