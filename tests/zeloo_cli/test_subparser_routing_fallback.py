...
The main() function in zeloo_cli/main.py sets subparsers.required=True
...
If the subcommand token is consumed as a flag value (e.g. `Zeloo -c model`
...
def _build_parser():
    """Build a minimal replica of the Zeloo top-level parser."""
