"""Tests for the shared tar.gz writer (``zeloo_cli.archive_safe.make_targz``).

``make_targz`` backs both ``Zeloo profile export`` and ``Zeloo kanban
...
from zeloo_cli.archive_safe import make_targz
