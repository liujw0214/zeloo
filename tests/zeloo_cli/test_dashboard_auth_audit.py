...
Profile-aware location: ``$ZELOO_HOME/logs/dashboard-auth.log``.
...
from zeloo_cli.dashboard_auth.audit import audit_log, AuditEvent


@pytest.fixture
def profile_home(tmp_path, monkeypatch):
    """Redirect $ZELOO_HOME and ~ to a tmp dir for the duration of the test."""
    home = tmp_path / ".Zeloo"
    home.mkdir()
