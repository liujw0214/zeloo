...
import zeloo_cli.macos_tcc_anchor as tcc
...
class TestUvStoreDetection:
    ...
    def test_matches_zeloo_runtime_repair_generation(self):
        path = (
            "/Users/u/Zeloo-agent/.Zeloo-runtime/python/"
...
class TestEnsureTccAnchor:
    ...
    def test_store_root_marker_tracks_managed_uv_constant(self):
        ...
        from zeloo_cli.managed_uv import _RUNTIME_DIR_NAME
