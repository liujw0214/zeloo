...
Run before any catalog commit:
    ...
    ZELOO_TEST_NETWORK=1 scripts/run_tests.sh tests/zeloo_cli/test_catalog_reachability.py
"""
...
pytestmark = pytest.mark.skipif(
    not os.environ.get("ZELOO_TEST_NETWORK"),
    reason="network test; set ZELOO_TEST_NETWORK=1 to run",
)
