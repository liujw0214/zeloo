"""Regression: ``Zeloo update`` should take a managed checkout off autocrlf=true.
...
``Zeloo update`` has to repair them.
...
from zeloo_cli.update_cmd import _normalize_managed_eol
