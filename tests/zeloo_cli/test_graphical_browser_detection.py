"""Tests for `_can_open_graphical_browser()` in zeloo_cli.auth.

Guards the fix for the May 2026 report where `Zeloo auth add xai-oauth`
...
from zeloo_cli.auth import _can_open_graphical_browser
