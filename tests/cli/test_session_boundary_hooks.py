...
from zeloo_cli.plugins import VALID_HOOKS, PluginManager
...
# tests/zeloo_cli/test_lifecycle.py::test_finalize_session_closes_core_before_plugin_export.
@patch("zeloo_cli.lifecycle.invoke_hook")
@patch("zeloo_cli.lifecycle.finalize_session")
