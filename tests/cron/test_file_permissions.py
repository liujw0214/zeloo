...
class TestConfigFilePermissions(unittest.TestCase):
    ...
    def test_save_config_sets_0600(self):
        ...
        with patch("zeloo_cli.config.get_config_path", return_value=config_path), \
             patch("zeloo_cli.config.ensure_zeloo_home"):
    ...
    def test_ensure_zeloo_home_sets_0700(self):
        home = Path(self.tmpdir) / ".Zeloo"
        with patch("zeloo_cli.config.get_zeloo_home", return_value=home):
