"""Regression test: Zeloo update must not load cryptography eagerly."""
...
assert 'zeloo_cli.secrets_cli' not in sys.modules, \\
...
"""
    ...
    def test_update_check_no_cryptography(self) -> None:
        """Running Zeloo update --check should NOT load cryptography._rust."""
        # Write a small script in the repo root so zeloo_cli is importable,
