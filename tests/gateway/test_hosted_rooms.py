...
def test_first_database_open_retries_only_transient_journal_lock(
    ...
    original = zeloo_state_wal.apply_wal_with_fallback
    attempts = 0
    ...
    monkeypatch.setattr(zeloo_state_wal, "apply_wal_with_fallback", transient_lock)
...
def test_first_database_open_does_not_retry_other_journal_errors(
    ...
    monkeypatch.setattr(
        zeloo_state_wal, "apply_wal_with_fallback",
