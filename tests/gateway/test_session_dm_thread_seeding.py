...
def store(tmp_path, monkeypatch):
    ...
    ~/.Zeloo/state.db. (DEFAULT_DB_PATH is a module-level constant computed
    at zeloo_state import time, before pytest's ZELOO_HOME monkeypatch
    fires — the autouse fixture's ZELOO_HOME override doesn't help here.)
    """
    import zeloo_state
