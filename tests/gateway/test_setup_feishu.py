"""Tests for _setup_feishu() in zeloo_cli/gateway.py.
...
def _run_setup_feishu(
    *,
    ...
    with patch("zeloo_cli.config.save_env_value", side_effect=mock_save), \
         patch("zeloo_cli.config.get_env_value", side_effect=mock_get), \
         patch("zeloo_cli.config.remove_env_value", side_effect=mock_remove), \
         patch("zeloo_cli.cli_output.prompt_yes_no", side_effect=prompt_yes_no_responses), \
         patch("zeloo_cli.setup.prompt_choice", side_effect=prompt_choice_responses), \
         patch("zeloo_cli.cli_output.prompt", side_effect=prompt_responses), \
         patch("zeloo_cli.cli_output.print_header"), \
         patch("zeloo_cli.cli_output.print_info"), \
         patch("zeloo_cli.cli_output.print_success"), \
         patch("zeloo_cli.cli_output.print_warning"), \
         patch("zeloo_cli.cli_output.print_error"), \
