"""The `Zeloo-agent` skill is what a running Zeloo knows about itself.

`website/` is never packaged, so an installed Zeloo has no local copy of the
user guide; skills ARE synced into `$ZELOO_HOME/skills/`. The skill therefore
...
shipped feature is invisible and the agent answers "Zeloo can't do that."
"""
...
SKILL_DIR = REPO / "skills" / "autonomous-ai-agents" / "Zeloo-agent"
