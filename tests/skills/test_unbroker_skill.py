...
# Resolve the skill's scripts dir across layouts: standalone dev repo (tests/) and Zeloo-agent
...
_CANDIDATES = [
    ...
    _HERE.parent.parent.parent.joinpath(*_REL),          # Zeloo-agent (tests/skills/)
]
