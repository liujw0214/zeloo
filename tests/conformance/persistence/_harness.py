...
def make_zeloo_home(base: Path, journal_mode: str) -> Path:
    """Create an isolated ZELOO_HOME whose config pins ``database.journal_mode``.
    ...
    """
    home = base / f"Zeloo-home-{journal_mode}"
