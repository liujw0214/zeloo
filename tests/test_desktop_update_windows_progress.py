...
window keeps moving through the long silent stretches (`Zeloo update`, pip,
...
def test_progress_advances_while_the_orchestrator_blocks(tmp_path: Path) -> None:
    ...
    env["ZELOO_SELFTEST_HOLD_SECONDS"] = "30"
    ...
    try:
        ...
        # boot default instead ('Zeloo will open once done.' ==
