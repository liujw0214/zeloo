...
// by main.ts (`setBackgroundThrottling` driven by the merged `Zeloo:active-work`
...
// (the "Zeloo idles at 20% CPU while minimized" bug). The preload path is
...
// conversation started by the "Hey Zeloo" wake word has NO preceding click,
