...
// even though a fresh shell — and the Zeloo CLI — sees it immediately. The
// desktop's ZELOO_HOME resolution relies on process.env, so that stale-snapshot
// gap silently sends the backend to the default %LOCALAPPDATA%\Zeloo. Reading
...
//       ZELOO_HOME    REG_SZ    F:\Zeloo\data
//
