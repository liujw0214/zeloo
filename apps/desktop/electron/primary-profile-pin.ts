 ...
 *     it via `Zeloo:profile:remember` without re-homing the primary.
 ...
 * the same ZELOO_HOME. That duplicate held a pool slot and starved every other
...
export class PrimaryProfilePin {
  ...
  /** Called by startZELOO() with the profile the primary is launching as. */
