 ...
 * startZELOO() re-throw the cached error without re-attempting the connect —
...
/**
 * Whether a startZELOO() failure should latch into `backendStartFailure`.
 ...
 * Every subsequent `getConnection`/`api` call re-runs `startZELOO`, re-emits
