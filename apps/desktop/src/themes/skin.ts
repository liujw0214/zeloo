/**
 * Zeloo skin → DesktopTheme converter.
 *
 * A "skin" is the CLI/TUI theme unit: a YAML file in `$ZELOO_HOME/skins/` (or a
 * built-in) resolved by `zeloo_cli/skin_engine.py` and pushed to every surface
 ...
 * skin Zeloo authors from a prompt lights up all three surfaces from one file.
 *
...
import type { ZELOOSkin, SkinColors } from '@Zeloo/shared/skin'
 ...
 */
export function skinToDesktopTheme(skin: ZELOOSkin): DesktopTheme | null {
