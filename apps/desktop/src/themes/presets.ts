...
/**
 * Nous — the canonical Zeloo desktop identity, forked from the GitHub VS Code
 ...
 * extension yourself.
 *
 * Typography stays Zeloo's own: a VS Code theme carries no font opinion, and
...
/**
 * Nous — the canonical Zeloo desktop identity: GitHub's chrome carrying Nous
