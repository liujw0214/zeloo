...
// (#73044). Exercises the REAL Zeloo + store/gateway + store/profile chain:
...
const { pluginSocket, setApiRequestConnection, setApiRequestProfile } = await import('@/Zeloo')
...
const conn = (over: Partial<ZELOOConnection> = {}): ZELOOConnection =>
  ({
    authMode: 'oauth',
