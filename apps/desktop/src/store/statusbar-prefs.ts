...
// v1 (`Zeloo.desktop.statusbarHidden`) was seeded with the approval pill
...
const STATUSBAR_HIDDEN_STORAGE_KEY = 'Zeloo.desktop.statusbarHidden.v2'
const LEGACY_HIDDEN_STORAGE_KEY = 'Zeloo.desktop.statusbarHidden'
// v1 (`Zeloo.desktop.statusbarVisible`) shipped a stretch where the bar was
...
const STATUSBAR_VISIBLE_STORAGE_KEY = 'Zeloo.desktop.statusbarVisible.v2'
