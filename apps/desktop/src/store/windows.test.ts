...
function installBridge(
  openSessionWindow?: Window['ZELOODesktop']['openSessionWindow'],
  openWindow?: Window['ZELOODesktop']['openWindow'],
  openBrowserWindow?: Window['ZELOODesktop']['openBrowserWindow']
) {
