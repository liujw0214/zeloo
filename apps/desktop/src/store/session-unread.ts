...
function rehydrateFromDiskOnce(): void {
  ...
  try {
    const rawSeen = readKey('Zeloo.desktop.sessionSeenCounts')
    ...
    const rawMarkers = readKey('Zeloo.desktop.unreadFinishedSessions')
