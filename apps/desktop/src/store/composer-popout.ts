...
const POPOUT_STORAGE_KEY = 'Zeloo.desktop.composerPopout.zones.v1'
const POPOUT_GESTURES_ENABLED_STORAGE_KEY = 'Zeloo.desktop.composerPopout.gesturesEnabled'
...
const LEGACY_ENABLED_KEY = 'Zeloo.desktop.composerPopout.enabled'
const LEGACY_POSITION_KEY = 'Zeloo.desktop.composerPopout.position'
