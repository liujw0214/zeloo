...
function identityForConnection(connection: ZELOOConnection | null): string {
  if (!connection) {
    return ''
  }
...
export function syncCronModelImpactConnection(connection: ZELOOConnection | null): void {
