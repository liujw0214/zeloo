...
export interface PetInfo {
  ...
  // the Zeloo "run" activity state uses the in-place running row).
 ...
 * ZELOO_HOME — so every pet RPC carries this. The gateway no-ops it for the
 ...
 */
const ROAM_KEY = 'Zeloo.desktop.pet-roam.v1'
