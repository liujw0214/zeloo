...
import type { ZELOOConfigRecord, SessionInfo } from '@/types/Zeloo'
...
// / Program Files), which buried any files Zeloo wrote there.
function DefaultProjectDirSetting() {
  ...
  useEffect(() => {
    ...
    // / Storybook / non-Electron context `window.ZELOODesktop` is
    ...
    const settings = window.ZELOODesktop?.settings
