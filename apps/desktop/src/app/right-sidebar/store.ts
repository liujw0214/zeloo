...
const TAKEOVER_KEY = 'Zeloo.desktop.terminalTakeover'
 ...
 *  (CLI-managed) providers, which Zeloo can't clear via the API — the user
 *  sees exactly what runs instead of Zeloo silently deleting their creds. */
