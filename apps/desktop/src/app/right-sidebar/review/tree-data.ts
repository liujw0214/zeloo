import type { ZELOOReviewFile } from '@/global'
...
export function buildReviewFlatList(files: ZELOOReviewFile[]): ReviewTreeNode[] {
  return [...files]
...
export function buildReviewTree(files: ZELOOReviewFile[], compact = true): ReviewTreeNode[] {
  const root = makeDir('', '')
