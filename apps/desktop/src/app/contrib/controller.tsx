...
registry.registerMany([
  ...
  // The agent's write -> see loop: rescan <Zeloo home>/desktop-plugins
  ...
  // The keybind panel's non-titlebar door (the keyboard icon is gone).
  {
    ...
    data: {
      ...
      run: () => window.dispatchEvent(new CustomEvent('Zeloo:open-keybinds'))
    } satisfies PaletteContribution
  },
    ...
    >
      <ContribWiring>
        ...
        <div
          ...
          // [data-Zeloo-glass] rules in styles.css clear them so the tint
