...
import { type DroppedFile, extractDroppedFiles, ZELOO_PATHS_MIME } from './use-composer-actions'
...
const dragKindOf = (event: ReactDragEvent): DragKind =>
  dragHasAttachments(event.dataTransfer, ZELOO_PATHS_MIME) ? 'files' : null
