...
import type { ZELOOGitBranch } from '@/global'
...
const branchActionLabel = (branch: ZELOOGitBranch, copy: BranchActionCopy) => {
...
export function WorktreeDialog() {
  ...
  const [branches, setBranches] = useState<ZELOOGitBranch[]>([])
  ...
  const convert = async (branch: ZELOOGitBranch) => {
    if (pending || !repoPath || !branch) {
      return
    }
