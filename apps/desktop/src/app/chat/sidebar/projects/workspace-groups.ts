...
import type { ProjectInfo, SessionInfo } from '@/Zeloo'
 ...
 * repo shows its branches/worktrees even when they have no Zeloo sessions yet.
...
export function mergeRepoWorktreeGroups(
  ...
  discoveredWorktrees?: ZELOOGitWorktree[]
): SidebarSessionGroup[] {
