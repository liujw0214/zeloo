...
import { getZELOOConfigRecord, listAllProfileSessions } from '@/Zeloo'
...
// Zeloo session ids: <YYYYMMDD>_<HHMMSS>_<6 hex>. Used to offer a direct
        ...
        : []),
      {
        ...
        items: [
          ...
          },
          {
            ...
            icon: Download,
            id: 'cc-update-Zeloo',
            keywords: ['update', 'upgrade', 'Zeloo', 'version', 'system', 'restart'],
            label: cc.updateZELOO,
