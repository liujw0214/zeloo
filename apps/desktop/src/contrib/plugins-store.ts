 ...
 * `<Zeloo home>/desktop-plugins/*` disk door — incl. agent-written ones),
...
const DECISIONS_KEY = 'Zeloo.desktop.pluginDecisions.v2'
const LEGACY_DISABLED_KEY = 'Zeloo.desktop.disabledPlugins.v1'
