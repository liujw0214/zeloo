...
export const en: Translations = {
  connectors: {
    ...
    disclaimer: 'Connecting is optional. Only authorize the apps you want Zeloo to use.',
    execution: 'Connector tools'
  },

  sessionImport: {
    title: 'Continue from another app',
    subtitle: 'Bring a conversation into Zeloo and pick up where you left off.',
    ...
    chooseHelp: 'Choose a session to read its history before bringing it into Zeloo.',
    ...
    you: 'You',
    snapshot: 'This conversation is already in Zeloo. Open your existing copy to continue.',
    copyNotice:
      'Copies conversation text. Source files stay unchanged. Tool output and reasoning are not carried over.',
    importing: 'Importing…',
    open: 'Open in Zeloo',
    continue: 'Continue in Zeloo',
  ...
  boot: {
    ready: 'Zeloo Desktop is ready',
    desktopBootFailedWithMessage: message => `Desktop boot failed: ${message}`,
    steps: {
      connectingGateway: 'Connecting live desktop gateway',
      loadingSettings: 'Loading Zeloo settings',
      loadingSessions: 'Loading recent sessions',
      retryingRemoteBackend: 'Reconnecting to the remote Zeloo backend…',
      startingDesktopConnection: 'Starting desktop connection',
      startingZELOODesktop: 'Starting Zeloo Desktop…'
    },
    errors: {
      backgroundExited: 'Zeloo background process exited.',
      backgroundExitedDuringStartup: 'Zeloo background process exited during startup.',
  ...
  notifications: {
    ...
    backendOutOfDateMessage:
      'Your Zeloo backend is older than this desktop build and may not work correctly. Update to align them.',
    installMethodUnsupportedTitle: 'Unsupported install method',
    updateZELOO: 'Update Zeloo',
    ...
    errors: {
      ...
      methodNotAllowed:
        'The desktop backend rejected that request (405 Method Not Allowed). Try restarting Zeloo Desktop.',
    ...
    native: {
      ...
      inputBody: 'Zeloo is waiting for your response.',
      turnDoneTitle: 'Zeloo finished',
      turnDoneBody: '',
  ...
  sendDiagnostics: {
    ...
    failedHint:
      'You can also run `Zeloo debug share --nous` from a terminal, or `Zeloo debug share --local` to print the report without uploading.',
  ...
  settings: {
    ...
    resetConfirm: 'Reset all settings to Zeloo defaults?',
    ...
    plugins: {
      ...
      installModal: {
        ...
        catalogPinned: (name, sha) =>
          `Zeloo catalog entry "${name}" — the agent component installs at the reviewed pin${sha ? ` ${sha}` : ''}, not the branch tip.`,
    ...
    vault: {
      ...
      otpHint: 'The "setup key" the site shows when you enable 2FA. With it saved, Zeloo generates the codes itself.',
      ...
      sources: {
        ...
        notInstalled: name =>
          `Not detected. Install the ${name} command-line tool and sign in to it; Zeloo picks it up automatically.`,
        disabledDesc: 'Detected but turned off for Zeloo.',
        lockedDesc: 'Detected. The agent will ask you to unlock it when it needs a login, or unlock now.',
        unlockedDesc: 'Unlocked for this session. Locks automatically after 30 minutes idle or when Zeloo closes.',
        statusLocked: 'Locked',
    ...
    notifications: {
      ...
      focusedHint: 'Completion alerts only fire while Zeloo is in the background.',
      kinds: {
        approval: {
        ...
        input: {
          label: 'Input needed',
          description: 'Zeloo asked a question or needs a password or secret.'
        },
        turnDone: {
          label: 'Response ready',
          description: 'A turn finished while Zeloo was in the background.'
        },
        turnError: {
          label: 'Turn failed',
        ...
        plugin: {
          ...
          description: 'A desktop plugin sent a notification while Zeloo was in the background.'
        }
      },
    ...
    appearance: {
      ...
      colorModeDesc: 'Pick a fixed mode or let Zeloo follow your system setting.',
      ...
      reactionsDesc: 'iMessage-style emoji tapbacks — react to messages, and Zeloo can react to yours.',
      tipsTitle: 'In-App Tips',
      tipsDesc:
        'A small bubble pointing at one part of the app, shown occasionally while idle and by Zeloo when it helps. Each tip appears once.',
      tipsReset: (count: number) => `Show ${count} ${count === 1 ? 'tip' : 'tips'} again`,
      toursTitle: 'Guided Tours',
      toursDesc: 'Let Zeloo walk you through the app, dimming the screen and spotlighting each step.',
      ...
      pet: {
        title: 'Pet',
        intro:
          'Adopt an animated petdex mascot that floats over the app and reacts to what Zeloo is doing — running while tools execute, celebrating on success, sulking on errors.',
        restartHint:
          'Pets need a quick restart — the running app started before this feature was added. Quit and reopen Zeloo, then come back here.',
        on: 'On',
        off: 'Off',
        scaleTitle: 'Size',
    ...
    about: {
      heading: 'Zeloo Desktop',
      version: value => `Version ${value}`,
      versionUnavailable: 'Version unavailable',
      bundleOutOfSync: 'App build out of date',
      bundleOutOfSyncDesc:
        'The Zeloo runtime was updated, but the desktop app itself is still an older build — new interface features (like Bot Mode) will be missing until it updates. Run the update below to rebuild the app. If that doesn\u2019t clear this warning, reinstall from the latest desktop installer.',
      bundleOutOfSyncAction: 'Get the installer',
      bundleSwapPending: 'Restart to finish the update',
      bundleSwapPendingDesc:
        'The updated app is already installed — Zeloo only needs to restart to load it. Chats and settings are untouched.',
      bundleSwapPendingAction: 'Restart Zeloo',
      updates: 'Updates',
      checkNow: 'Check now',
      checking: 'Checking…',
      seeWhatsNew: "See what's new",
      ...
      automaticUpdatesDesc:
        'Zeloo checks for updates automatically in the background and lets you know when one is ready.',
    ...
    config: {
      ...
      loading: 'Loading Zeloo configuration...',
    ...
    quickEntry: {
      ...
      enabledDesc:
        'Summon a small composer from anywhere with a global shortcut and fire a prompt without opening Zeloo.',
    ...
    connections: {
      ...
      intro: 'Manage this device and every Zeloo gateway it can reach through remote, SSH, or Cloud connections.',
      stagedNote:
      ...
      updateSkippedCloud: 'Managed by Zeloo Cloud',
      kindLocal: 'Local',
      kindRemote: 'Remote gateway',
      kindCloud: 'Zeloo Cloud',
      kindSsh: 'SSH',
      kindLocalDesc: 'The Zeloo runtime managed by this app.',
      kindRemoteDesc: 'A Zeloo gateway reachable over HTTP(S) — LAN, Tailscale, or the internet.',
      kindCloudDesc: 'A hosted instance discovered through your Zeloo Cloud account.',
      kindSshDesc: 'A Zeloo install reached over SSH.',
      labelTitle: 'Name',
      ...
      headersDesc:
        'Sent with every HTTP and WebSocket request to this gateway — for access proxies such as Cloudflare Access (CF-Access-Client-Id / CF-Access-Client-Secret). Values are stored encrypted. Headers Zeloo manages (Authorization, Cookie, Host…) are ignored.',
      ...
      cloudAddHint:
        'Tip: signing in under Zeloo Cloud above discovers your agents automatically — use this form only to register a known instance URL by hand.',
    ...
    gateway: {
      ...
      intro:
        'Local by default. Use remote when this app should drive a Zeloo backend elsewhere. Gateway connections are machine-level; profiles are discovered from the gateways you connect.',
      envOverrideTitle: 'Environment variables are controlling this desktop session.',
      envOverrideDesc:
        'Unset ZELOO_DESKTOP_REMOTE_URL and ZELOO_DESKTOP_REMOTE_TOKEN to use the saved setting below.',
      modeTitle: 'Connection mode',
      localTitle: 'Local gateway',
      localDesc: 'Start a private Zeloo backend on localhost. This is the default and works offline.',
      remoteTitle: 'Remote gateway',
      remoteDesc: 'Connect this desktop shell to a remote Zeloo backend.',
      remoteAuthHint: 'Hosted gateways use OAuth or a username and password; self-hosted ones may use a session token.',
      cloudTitle: 'Zeloo Cloud',
      cloudDesc: 'Sign in once to Zeloo Cloud and pick from the agents on your account — no URL to paste.',
      cloudSignInTitle: 'Zeloo Cloud',
      cloudSignIn: 'Sign in to Zeloo Cloud',
      cloudSignedIn: 'Signed in to Zeloo Cloud',
      cloudNeedsSignIn: 'Sign in to Zeloo Cloud to discover the agents on your account.',
      ...
      cloudDiscoverFailed: 'Could not load your Zeloo Cloud agents',
      cloudConnectFailed: 'Could not connect to that agent',
      cloudSignInFailed: 'Zeloo Cloud sign-in failed',
      cloudSignedOutTitle: 'Signed out of Zeloo Cloud',
      cloudSignedOutMessage: 'Cleared the Zeloo Cloud session.',
      ...
      remoteUrlDesc: 'Base URL for the remote dashboard backend. Path prefixes are supported, for example /Zeloo.',
      ...
      restartingMessage: 'Zeloo Desktop will reconnect using the saved settings — the shell stays open.',
      savedMessage: 'Saved for the next restart.',
      connectedTo: (baseUrl, version) => `Connected to ${baseUrl}${version ? ` · Zeloo ${version}` : ''}`,
      ...
      sshDesc:
        'Zeloo is launched on the remote over SSH and tunneled to this app — nothing to start or expose yourself. Requires working key-based SSH access to the host.',
      ...
      sshZELOOPathTitle: 'Zeloo path (optional)',
      sshZELOOPathDesc: 'Full path to the remote Zeloo binary. Blank = auto-detect.',
      sshZELOOPathPlaceholder: 'auto-detect',
      sshTestConnection: 'Test SSH',
      sshConnect: 'Connect',
      sshButtonsHint: 'Save applies on the next launch. Connect reconnects now.',
      sshReachable: (host, platform) => `Reachable: ${host} (${platform}) — Zeloo found`,
      ...
      sshErrAuth:
        'SSH authentication failed. Load your key into the ssh-agent (ssh-add) or set an IdentityFile in ~/.ssh/config — Zeloo runs ssh non-interactively.',
      sshErrHostKey:
        'The host key has CHANGED since you last connected. Verify this is expected, then run ssh-keygen -R <host> and reconnect.',
      sshErrNotInstalled:
        'Zeloo is not installed on the remote host. Install it there (curl -fsSL https://Zeloo-agent.nousresearch.com/install.sh | sh) or set the Zeloo path.',
      sshErrPlatform:
        'Unsupported remote platform. Zeloo Desktop SSH mode supports Linux, macOS, and Windows remote hosts.',
      sshErrTimeout: 'SSH connection timed out. The host may be unreachable or asleep.',
      sshErrUpdateRequired: 'Update Zeloo on the remote host before connecting with Desktop SSH.',
    ...
    mcp: {
      ...
      deepLinkDescription:
        'A link asked to add this MCP server to Zeloo. Review the exact configuration below — it comes from the link, not from Zeloo.',
    ...
    localModels: {
      ...
      runtimeInstalledDetail: (tag, backend) =>
        `Build ${tag}, ${backend} backend. Zeloo starts and manages the server for you.`,
      ...
      upToDateDetail: (tag, backend) => `Running llama.cpp ${tag} (${backend}) — the latest build Zeloo ships.`,
    ...
    providers: {
      ...
      intro:
        'Sign in with a subscription — no API key to copy. Zeloo runs the browser sign-in for you, right here in the app.',
      connected: 'Connected',
      collapse: 'Collapse',
      ...
      localEndpoint: {
        ...
        description: 'Point Zeloo at any OpenAI-compatible endpoint (Zyphra, vLLM, llama.cpp, Ollama, etc).'
      },
    ...
    toolsets: {
      ...
      browserRealProfile: {
        ...
        prompt: {
          ...
          body: 'Let Zeloo browse with a snapshot of your default browser profile, so sites open already signed in.',
  ...
  skills: {
    ...
    skillArchivedMessage: 'Restorable via Zeloo curator restore.',
    tabPlugins: 'Plugins',
    plugins: {
      ...
      legacyBackend: 'This backend predates key-addressed plugin toggles — update Zeloo to manage it here.',
      ...
      catalogProvenance: (sha: string) => `Installed from the Zeloo catalog${sha ? ` at pin ${sha}` : ''}.`,
  ...
  starmap: {
    ...
    emptyDesc: 'As Zeloo builds skills and memories for your work, they appear here.',
    share: 'Share map',
    shareHint:
  ...
  commandCenter: {
    ...
    pets: {
      ...
      staleBackend: 'Restart Zeloo to use pets — the backend predates this feature.',
    ...
    generatePet: {
      ...
      staleBackend: 'Update Zeloo to generate pets.',
      backgroundHint: 'You can close this — Zeloo will notify you when it’s done.',
    ...
    nav: {
      ...
      settings: { title: 'Settings', detail: 'Configure Zeloo desktop' },
    ...
    ZELOOActiveSessions: (version, count) => `Zeloo ${version} · Active sessions ${count}`,
  ...
  messaging: {
    ...
    telegramQr: {
      ...
      subtitle: 'Both options connect a bot you control and save its credentials only to this Zeloo installation.',
      quickSetup: 'Quick setup',
      recommended: 'Recommended',
      quickHelp:
        'Scan a QR code and confirm in Telegram. Zeloo creates the bot and detects your Telegram user ID automatically.',
    ...
    fieldCopy: {
      ...
      MATRIX_USER_ID: { label: 'Bot user ID', placeholder: '@Zeloo:example.org' },
  ...
  profiles: {
    ...
    remoteOverride: {
      ...
      description: 'Sessions in this profile will run on the remote Zeloo you point it at, instead of this computer.',
      urlLabel: 'Remote address',
      urlPlaceholder: 'https://Zeloo.example.com',
    ...
    deleting: 'Deleting...',
    createDesc: 'Profiles are independent Zeloo environments: separate config, skills, and SOUL.md.',
    nameLabel: 'Name',
  ...
  cron: {
    ...
    modelImpact: {
      ...
      saveFailed: 'Zeloo did not save that model change.',
    ...
    newCron: 'New cron',
    emptyDescNew:
      'Schedule a prompt to run on a cron expression. Zeloo will run it and deliver results to the destination you pick.',
  ...
  sidebar: {
    ...
    projects: {
      ...
      staleBackend:
        'Update the Zeloo backend to create projects — your backend is older than this desktop app (Settings → Updates → Backend).',
      deleteConfirm: 'This removes the saved project from Zeloo. Files, git repos, and worktrees stay untouched.',
      ...
      worktreeStaleBackend:
        'Update the Zeloo backend to create worktrees over this remote connection — it predates the git worktree API.',
  ...
  composer: {
    ...
    placeholderStarting: 'Starting Zeloo...',
    placeholderReconnecting: 'Reconnecting to Zeloo…',
    ...
    attachUrlDesc: 'Zeloo will fetch the page and include it as context for this turn.',
  ...
  statusStack: {
    ...
    coding: {
      ...
      agentShip: 'Ask Zeloo to open PR',
  ...
  updates: {
    stages: {
      ...
      pull: 'Almost there…',
      pydeps: 'Finishing up…',
      update: 'Updating Zeloo…',
      rebuild: 'Rebuilding the desktop app…',
      restart: 'Restarting Zeloo…',
    ...
    unsupportedMessage: 'This version of Zeloo can’t update itself from inside the app.',
    ...
    manualBody: 'You installed Zeloo from the command line, so updates run there too. Paste this into your terminal:',
    manualPickedUp: 'Zeloo will pick up the new version next time you launch it.',
    guiSkewTitle: 'Update the desktop app',
    guiSkewBody:
      'The backend was updated, but this desktop app package wasn’t changed. Update or reinstall the Zeloo desktop app (your AppImage / .deb / .rpm) to match.',
    copy: 'Copy',
    copied: 'Copied',
    done: 'Done',
    applyingBody:
      'The Zeloo updater takes over in its own window and reopens Zeloo automatically when it’s done. Please don’t reopen Zeloo yourself while it’s updating.',
    applyingBodyBackend:
      'The remote backend is applying the update and will restart. Zeloo reconnects automatically when it’s back.',
    applyingClose: 'This window will close while the update runs, then Zeloo reopens on its own.',
    errorTitle: 'Update didn’t finish',
    errorBody: 'No worries — nothing was lost. You can try again now.',
    blockerTitle: 'Close local previews to update Zeloo?',
    blockerBody:
      'Zeloo needs to stop these local previews before updating. This will not modify or delete your files.',
    foreignBlockerTitle: 'Close other processes to update Zeloo',
    foreignBlockerBody:
      'Zeloo can’t safely close these processes automatically. Close the app, terminal, or service that owns each one, then try the update again.',
    mixedBlockerBody:
      'Zeloo can close the local previews listed below. Other processes must be closed manually before the update can continue.',
  ...
  guidedGreeting: {
    line: "Hey, come on in. I'm Zeloo. Give me two minutes to set the place up around you, then we'll put me to work on something you actually want done.\n\nFirst though, what should I call you?",
  ...
  install: {
    ...
    oneTimeTitle: 'Zeloo needs a one-time install',
    ...
    setupChoiceTitle: 'Set up Zeloo Desktop',
    setupChoiceDesc:
      'Connect this app to a Zeloo gateway you already run, or install Zeloo locally on this computer.',
    connectExistingTitle: 'Connect to existing Zeloo',
    ...
    installLocalTitle: 'Install Zeloo locally',
    installLocalDesc: 'Download Zeloo, create its Python environment, and run the backend on this computer.',
    localStartUnavailable: 'Local installation could not start. Restart Zeloo Desktop and try again.',
    remoteSetupTitle: 'Connect to existing Zeloo',
    remoteSetupDesc: 'Enter your gateway URL. Zeloo Desktop will detect whether it needs a token or browser sign-in.',
    remoteUrlTitle: 'Gateway URL',
    remoteUrlDesc: 'Use the base URL of the Zeloo gateway, including https:// when remote.',
    remoteUrlPlaceholder: 'https://gateway.example.com/Zeloo',
    probing: 'Detecting gateway authentication...',
    probeError: 'Could not reach that Zeloo gateway.',
    identityProvider: 'your identity provider',
    authTitle: 'Authentication',
    ...
    settingUpTitle: 'Setting up Zeloo Agent',
    finishingTitle: 'Finishing up',
    failedDesc:
      'One of the install steps failed. On Windows, this can happen if another Zeloo CLI or desktop instance is running. Stop any running Zeloo instances, then retry. Check the details below or the desktop log for the full transcript.',
    activeDesc:
  ...
  onboarding: {
    headerTitle: "Let's get you setup with Zeloo Agent",
    headerDesc: 'Connect a model provider to start chatting. Most options take one click.',
    preparingInstall: 'Zeloo is finishing install. This usually takes under a minute on first run.',
    starting: 'Starting Zeloo…',
    ...
    recommended: 'Recommended',
    connected: 'Connected',
    featuredPitch: 'One subscription, 300+ frontier models — the recommended way to run Zeloo',
    ...
    apiKeyOptions: {
      ...
      local: {
        short: 'self-hosted',
        description: 'Point Zeloo at a local or self-hosted OpenAI-compatible endpoint (vLLM, llama.cpp, Ollama, etc).'
      }
    },
    ...
    flowSubtitles: {
      ...
      device_code: 'Opens a verification page in your browser — Zeloo connects automatically',
    ...
    authorizeThere: 'Authorize Zeloo there.',
    ...
    autoBrowser: provider =>
      `We opened ${provider} in your browser. Authorize Zeloo there and you'll be connected automatically — nothing to copy or paste.`,
  ...
  freeTier: {
    ...
    alreadySignedInBody: 'This Zeloo is already signed in to a Nous account.'
  },
  ...
  shell: {
    ...
    statusbar: {
      ...
      desktopVersion: version => `Zeloo Desktop v${version}`,
      backendVersion: version => `Backend v${version}`,
      clientLabel: version => `client v${version}`,
      connectionSsh: host => `SSH: ${host}`,
      connectionRemote: host => `Remote: ${host}`,
      connectionCloud: host => `Cloud: ${host}`,
      connectionCloudTooltip: host => `Zeloo Cloud · ${host}`,
  ...
  preview: {
    ...
    largeBody: (label, size) => `${label} is ${size}. Zeloo will only show the first 512 KB.`,
    ...
    web: {
      ...
      tryAgain: 'Try again',
      restarting: 'Zeloo is restarting...',
      askRestart: 'Ask Zeloo to restart the server',
      lookingRestart: taskId => `Zeloo is looking for a preview server to restart (${taskId})`,
      restartingTitle: 'Restarting preview server',
      restartingMessage: 'Zeloo is working in the background. Watch the preview console for progress.',
      ...
      blankPageBody: 'Type an address above to browse, or ask Zeloo to open a page.',
      finishedRestarting: message => `Zeloo finished restarting the preview server${message ? `: ${message}` : ''}`,
      ...
      restartFailedMessage: 'Zeloo could not restart the server.',
      stillWorking:
        'Zeloo is still working, but no restart result has arrived yet. The server command may be running in the foreground.',
  ...
  assistant: {
    thread: {
      ...
      loadingResponse: 'Zeloo is loading a response',
    ...
    approval: {
      gatewayDisconnected: 'Zeloo gateway is not connected',
      ...
      alwaysDescription: pattern =>
        `This adds the “${pattern}” pattern to your permanent allowlist (~/.Zeloo/config.yaml). Zeloo won’t ask again for commands like this — in this session or any future one.`,
  ...
  prompts: {
    ...
    sudoDesc: 'Zeloo needs your sudo password to run a privileged command. It is sent only to your local agent.',
    sudoPlaceholder: 'sudo password',
    secretTitle: 'Secret required',
    secretDesc: 'Zeloo needs a credential to continue.',
    ...
    vaultSaveDesc: origin =>
      `Zeloo reached a sign-in page at ${origin} and has no login for it. Enter it once here; it is encrypted on this machine and filled into the page without the model ever seeing the password.`,
    ...
    vaultCodeDesc: site =>
      `${site} is asking for a one-time code (text message, email or authenticator app). Enter it here and Zeloo types it into the page; the model never sees it.`,
    vaultCodeLabel: 'Code',
    vaultCodeFootnote:
      'Tip: save the authenticator key with this login in Settings → Passwords & Logins and Zeloo enters codes for you.',
    vaultCodeSkip: 'Skip',
  ...
  desktop: {
    ...
    restartToUseSaveImage: 'Restart Zeloo Desktop to use Save Image.',
    restartToSaveImages: 'Restart Zeloo Desktop to save images',
    ...
    handoff: {
      ...
      timedOut: 'Timed out waiting for the gateway. Is `Zeloo gateway` running?'
    }
  },
  ...
  tips: {
    ...
    items: {
      ...
      skills: {
        title: 'Teach it once',
        text: 'Skills are folders of instructions Zeloo loads when the work calls for them.'
      },
      messaging: {
        title: 'Zeloo away from your desk',
        text: 'Connect Telegram, Discord, Slack and more — same agent, same memory.'
      },
      artifacts: {
        title: 'Everything Zeloo made',
      ...
      profiles: {
        ...
        text: 'Each one is its own Zeloo — own keys, own memory, own sessions.'
      },
      'composer-mentions': {
