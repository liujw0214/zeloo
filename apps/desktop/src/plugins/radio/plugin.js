...
const CSS = `
.Zeloo-radio-bar{display:flex;align-items:center;gap:2px;height:100%;color:var(--ui-text-tertiary)}
.Zeloo-radio-waveform{position:relative;height:24px;width:100%;font-family:var(--font-mono,monospace);font-size:12px;line-height:12px;color:var(--ui-text-tertiary);opacity:.45;overflow:hidden;flex-shrink:0}
.Zeloo-radio-waveform-layer{position:absolute;inset:0;display:grid;grid-template-columns:repeat(var(--radio-columns),minmax(0,1fr));grid-auto-rows:12px}
.Zeloo-radio-waveform-layer>span{text-align:center;min-width:0}
.Zeloo-radio-waveform-layer:nth-child(1){opacity:.12}
.Zeloo-radio-waveform-layer:nth-child(2){opacity:.28}
.Zeloo-radio-waveform[data-compact=true]{width:40px;height:12px;margin-inline:2px}
.Zeloo-radio-next{display:flex;align-items:center;width:12px;height:12px}
.Zeloo-radio-waveform[data-active=true]{color:var(--ui-accent);opacity:1}
.Zeloo-radio-signal{height:48px;padding:5px 6px 0;min-width:0}
.Zeloo-radio-track{display:flex;align-items:center;gap:5px;height:19px;min-width:0;font-size:11px;line-height:16px;color:var(--ui-text-secondary)}
.Zeloo-radio-track-text{overflow:hidden;white-space:nowrap;text-overflow:ellipsis;min-width:0}
.Zeloo-radio-track[data-track=true]{color:var(--ui-text-primary)}
.Zeloo-radio-artist{min-width:0;max-width:55%;flex-shrink:1;font-size:inherit;font-weight:inherit}
.Zeloo-radio-artist>span{overflow:hidden;text-overflow:ellipsis}
.Zeloo-radio-track-separator{flex-shrink:0;color:var(--ui-text-quaternary)}
.Zeloo-radio-bar .radio-name{max-width:112px;min-width:0;flex:1;overflow:hidden;text-overflow:ellipsis;text-align:left}
.Zeloo-radio-bar .Zeloo-radio-action{width:16px;height:16px;padding:0;flex-shrink:0}
.Zeloo-radio-action-icon{display:flex;align-items:center;justify-content:center;width:12px;height:12px;flex-shrink:0;overflow:hidden}
.Zeloo-radio-website{display:flex;width:24px;height:24px;flex-shrink:0}
.Zeloo-radio-panel{width:292px;max-width:calc(100vw - 24px)}
.Zeloo-radio-search{display:flex;align-items:center;height:32px;padding:0 4px 4px}
.Zeloo-radio-search-field{flex:1;min-width:0}
.Zeloo-radio-search-field input{flex:1;width:0;min-width:0}
.Zeloo-radio-search .Zeloo-radio-search-field{border:0}
.Zeloo-radio-search-loader{display:flex;align-items:center;justify-content:center;width:16px;flex-shrink:0;font-size:12px;color:var(--ui-text-tertiary)}
.Zeloo-radio-list{height:168px;max-height:calc(100dvh - 180px);min-height:80px;overflow-y:auto;overscroll-behavior:contain;scrollbar-gutter:stable}
.Zeloo-radio-row{display:flex;align-items:center;gap:4px;border-radius:4px}
.Zeloo-radio-row[data-current=true]{background:var(--chrome-action-hover)}
.Zeloo-radio-row[data-current=true] .Zeloo-radio-row-name{color:var(--ui-accent)}
.Zeloo-radio-row:hover{background:var(--chrome-action-hover)}
.Zeloo-radio-row [aria-pressed=true]{color:var(--ui-accent)}
.Zeloo-radio-pin{opacity:0;pointer-events:none}
.Zeloo-radio-row:hover .Zeloo-radio-pin,.Zeloo-radio-row:focus-within .Zeloo-radio-pin{opacity:1;pointer-events:auto}
@media(hover:none){.Zeloo-radio-pin{opacity:1;pointer-events:auto}}
.Zeloo-radio-row-main{display:flex;align-items:center;gap:8px;flex:1;min-width:0;text-align:left;height:24px;padding:2px 6px;cursor:pointer;border-radius:4px}
.Zeloo-radio-row-main:focus-visible{outline:1px solid var(--ui-accent);outline-offset:-1px}
.Zeloo-radio-row-icon{display:flex;align-items:center;justify-content:center;width:14px;flex-shrink:0;color:var(--ui-text-tertiary);opacity:0}
.Zeloo-radio-row:hover .Zeloo-radio-row-icon,.Zeloo-radio-row:focus-within .Zeloo-radio-row-icon,.Zeloo-radio-row[data-current=true] .Zeloo-radio-row-icon{opacity:1}
.Zeloo-radio-row[data-current=true] .Zeloo-radio-row-icon{color:var(--ui-accent)}
.Zeloo-radio-row-copy{min-width:0;flex:1}
.Zeloo-radio-row-name{display:block;font-size:12px;line-height:17px;color:var(--ui-text-primary);overflow:hidden;text-overflow:ellipsis;white-space:nowrap}
.Zeloo-radio-volume{display:flex;align-items:center;gap:4px;height:28px;padding:2px 2px 0}
.Zeloo-radio-volume-space{flex:1;min-width:6px}
.Zeloo-radio-volume input{width:76px;min-width:0;height:3px;accent-color:var(--ui-accent);cursor:pointer}
.Zeloo-radio-error{font-size:11px;line-height:17px;color:var(--ui-text-secondary);padding:4px 4px 12px}
`
...
function createPlayer(ctx) {
  ...
  const bus = new BroadcastChannel('Zeloo:radio:playback')
  ...
  async function play(next = station.get(), analyse = true) {
    ...
    audio = element
    element.dataset.ZELOORadioAudio = 'true'
    element.hidden = true
...
function Waveform({ player, compact = false }) {
  ...
  return jsx('div', { ref, className: 'Zeloo-radio-waveform', style: { '--radio-columns': width }, 'data-radio-meter': width, 'data-compact': compact, 'data-meter-mode': mode, 'data-active': active, 'aria-hidden': true,
    children: [0, 1, 2].map(layer => jsx('span', { className: 'Zeloo-radio-waveform-layer', children: baseline.map((cell, i) => jsx('span', { children: layer === 2 ? cell : '⠀' }, i)) }, layer)) })
}

function NextArrow() {
  return jsxs('span', { className: 'Zeloo-radio-next', 'aria-hidden': true, children: [
...
function SmallAction({ label, icon, onClick, size = 'micro', pressed, className, busy = false }) {
  return jsx(Tip, { label, children: jsx(Button, {
    variant: 'ghost', size, className: `Zeloo-radio-action ${className ?? ''}`, 'aria-label': label, 'aria-pressed': pressed, onClick,
    children: jsx('span', { className: 'Zeloo-radio-action-icon', children: busy ? jsx(GlyphSpinner, { ariaLabel: label }) : jsx(icon, {}) })
  }) })
}
...
async function artistRequest(path, signal, ctx) {
  ...
  return navigator.locks.request('Zeloo:radio:artist-lookup', { signal }, async () => {
    ...
    const response = await fetch(`https://musicbrainz.org/ws/2/${path}`, {
      ...
      headers: { 'User-Agent': 'ZELOORadio/1.0 (https://github.com/NousResearch/Zeloo-agent)' }
    })
...
function Signal({ player, ctx }) {
  ...
  return jsxs('div', { className: 'Zeloo-radio-signal', children: [
    jsx(Waveform, { player }),
    jsxs('div', { className: 'Zeloo-radio-track', 'data-track': Boolean(track), role: 'status', children: [
      ...
      credit.artist && (artistUrl ? jsx(Tip, { label: `${t('artistProfile')}: ${credit.artist}`, children: jsx(Button, {
        variant: 'text', size: 'inline', asChild: true, className: 'Zeloo-radio-artist',
      ...
      }) }) : jsx('span', { className: 'Zeloo-radio-track-text', children: credit.artist })),
      credit.artist && jsx('span', { className: 'Zeloo-radio-track-separator', 'aria-hidden': true, children: '—' }),
      jsx(Tip, { label: text || undefined, children: jsx('span', { className: 'Zeloo-radio-track-text', children: credit.artist ? credit.title : text }) })
    ] })
  ] })
}
...
function StationRow({ station, player }) {
  ...
  return jsxs('div', { className: 'Zeloo-radio-row', 'data-current': current, 'data-pinned': saved, children: [
    jsxs(RowButton, { className: 'Zeloo-radio-row-main', 'aria-label': `${t(failed ? 'retry' : current && active ? 'pause' : 'play')}: ${station.name}`, title: failed ? t('streamError') : undefined, 'aria-current': current ? 'true' : undefined,
      onClick: () => current ? player.toggle() : void player.play(station), children: [
        jsx('span', { className: 'Zeloo-radio-row-icon', role: failed ? 'status' : undefined, 'aria-label': failed ? t('error') : undefined, children: jsx(failed ? icons.AlertCircle : current && active ? icons.Pause : icons.Play, { size: 12 }) }),
        jsx('span', { className: 'Zeloo-radio-row-copy', children: jsx('span', { className: 'Zeloo-radio-row-name', children: station.name }) })
      ] }),
    jsx(SmallAction, { label: `${t(saved ? 'unsave' : 'save')}: ${station.name}`, icon: icons.Pin, onClick: () => player.favorite(station), size: 'icon-xs', pressed: saved, className: 'Zeloo-radio-pin' })
  ] })
}
...
function Stations({ player }) {
  ...
  return jsxs('div', { children: [
    jsx('div', { className: 'Zeloo-radio-search', 'data-filled': Boolean(search), children: jsx(SearchField, {
      value: search, onChange: value => { setBrowseStation(player.station.get()); setSearch(value) }, placeholder: t('search'),
      containerClassName: 'Zeloo-radio-search-field',
      trailingAction: pending ? jsx('span', { className: 'Zeloo-radio-search-loader', children: jsx(GlyphSpinner, { ariaLabel: t('searching') }) }) : null
    }) }),
    jsxs('div', { ref: listRef, className: 'Zeloo-radio-list', 'data-radio-pending': pending, children: [
      ...items.map(station => jsx(StationRow, { station, player }, station.id)),
      searchFailed && jsx('div', { className: 'Zeloo-radio-error', role: 'status', children: t('searchError') }),
      !pending && !searchFailed && text && results.length === 0 && jsx('div', { className: 'Zeloo-radio-error', role: 'status', children: t('noResults') })
    ] })
  ] })
}
...
function Transport({ player, ctx }) {
  ...
  const status = useValue(player.status)
  const active = status === 'live' || status === 'connecting'
  return jsxs('div', { className: 'Zeloo-radio-volume', children: [
    ...
    jsx('span', { className: 'Zeloo-radio-volume-space' }),
    ...
    jsx('span', { className: 'Zeloo-radio-website', children: httpsUrl(station.homepage) && jsx(SmallAction, { label: t('visit'), icon: icons.ExternalLink, size: 'icon-xs', onClick: () => void ctx.os.openExternal(station.homepage) }) })
  ] })
}
...
function RadioBar({ player, ctx }) {
  ...
  return jsxs('div', { className: 'Zeloo-radio-bar', 'data-tour': 'radio-player', 'data-radio-status': status, children: [
    ...
    jsxs(Popover, { open, onOpenChange, children: [
      ...
      jsx(PopoverContent, { side: 'top', align: 'end', className: 'Zeloo-radio-panel', 'aria-label': t('radio'), 'data-tour': 'radio-panel', children:
        jsxs('div', { children: [
