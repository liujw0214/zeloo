...
import { ackStoredSessionId, atom, haptic, host, markSessionUnreadFinished } from '@Zeloo/plugin-sdk'
 ...
 *  (Zeloo-agent#90102) and are discarded. Without `canonical_session` (older
