...
const relaySource = readFileSync(join(process.cwd(), 'src/plugins/Zeloo-bots/relay.ts'), 'utf8')
const repoRoot = join(process.cwd(), '..', '..')
const configDefaults = readFileSync(join(repoRoot, 'zeloo_cli/config_defaults.py'), 'utf8')
