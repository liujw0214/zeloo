 ...
 *    the primary profile surfaced as @default instead of @Zeloo;
 ...
 *    kanban/tool workers count too (Zeloo-agent#90268): a profile grinding
...
describe('previewKind classifies a roster preview', () => {
  ...
  it('surfaces the primary profile as @Zeloo, never @default (#89484)', () => {
    expect(fromBot("Message from agent 'default': deploy is green")).toBe('Zeloo')
