...
import { atom, host, useValue } from '@Zeloo/plugin-sdk'
...
export function previewKind(preview: null | string | undefined): { fromBot: null | string } {
  ...
  if (match) {
    ...
    // profile reads @Zeloo, never @default (#89484).
 ...
 *  (Zeloo-agent#90268). Older gateways omit worker_session — always false. */
