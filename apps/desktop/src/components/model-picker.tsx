...
import { getLocalModelsStatus } from '@/Zeloo'
...
import type { LocalModelLoadProgress, ModelOptionProvider, ModelPricing } from '@/types/Zeloo'
...
export function ModelPickerDialog({
  ...
  // the `Zeloo model` CLI picker, which shows the curated list verbatim.
