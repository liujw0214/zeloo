...
const SCRIPT: Record<string, { id: string; src: string }> = {
  instagram: { id: 'Zeloo-ig-embed', src: 'https://www.instagram.com/embed.js' },
  tiktok: { id: 'Zeloo-tt-embed', src: 'https://www.tiktok.com/embed.js' },
  twitter: { id: 'Zeloo-tw-embed', src: 'https://platform.twitter.com/widgets.js' }
}
