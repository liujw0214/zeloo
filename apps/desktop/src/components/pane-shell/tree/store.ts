...
const STORAGE_KEY = 'Zeloo.desktop.layoutTree.v2'

writeKey('Zeloo.desktop.layoutTree.v1', null)
 ...
 */
export const $activePresetId = atom<string>(readKey('Zeloo.desktop.layoutPreset.active') ?? 'default')

export function markActivePreset(id: string) {
  $activePresetId.set(id)
  writeKey('Zeloo.desktop.layoutPreset.active', id)
}
 ...
 */
const DISMISSED_KEY = 'Zeloo.desktop.dismissedPanes.v1'
...
const PANE_SHARE_KEY = 'Zeloo.desktop.paneShare.v1'
...
const HIDDEN_STRIP_TAB_KEY = 'Zeloo.desktop.hiddenStripTabs.v1'
...
writeKey('Zeloo.desktop.paneDockHeals.v1', null)
...
if ((import.meta.env.DEV || import.meta.env.VITE_PERF_PROBE === '1') && typeof window !== 'undefined') {
  ;(window as unknown as Record<string, unknown>).__ZELOO_LAYOUT_TREE__ = {
    close: closeTreePane,
