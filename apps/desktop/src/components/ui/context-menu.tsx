...
export const ZELOO_CONTEXT_MENU_TRIGGER_ATTR = 'data-Zeloo-context-menu-trigger'

function ContextMenuTrigger({ ...props }: React.ComponentProps<typeof ContextMenuPrimitive.Trigger>) {
  return (
    <ContextMenuPrimitive.Trigger data-slot="context-menu-trigger" {...props} data-Zeloo-context-menu-trigger="" />
  )
}
