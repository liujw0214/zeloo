...
import type { ModelOptionsResponse, SessionInfo } from '@/types/Zeloo'
 ...
 *
 * Only the leading status prefix (e.g. "Zeloo is thinking...") and the
 ...
 *  resolved comment as JSON (ZELOOPrComment shape); a malformed payload falls
