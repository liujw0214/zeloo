...
const SKIP_PROTO_RE = /^(?:file|data|mailto|javascript|blob|chrome|about|Zeloo):/i
...
export function fetchLinkTitle(url: string): Promise<string> {
  ...
  const bridge = typeof window === 'undefined' ? undefined : window.ZELOODesktop?.fetchLinkTitle
...
export function openExternalLink(href: string): void {
  if (href) {
    void window.ZELOODesktop?.openExternal?.(href)
  }
}
 ...
 * doesn't cost a context switch out of Zeloo, and it is the surface the agent
