...
describe('displayPath', () => {
  it('collapses a macOS home prefix to ~', () => {
    expect(displayPath('/Users/brooklyn/www/Zeloo-agent')).toBe('~/www/Zeloo-agent')
...
describe('pathLeaf', () => {
  it('returns the last segment', () => {
    expect(pathLeaf('/Users/me/www/Zeloo-agent')).toBe('Zeloo-agent')
    expect(pathLeaf('~/www/Zeloo-agent')).toBe('Zeloo-agent')
