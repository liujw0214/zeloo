...
cd apps/desktop
XCURSOR_SIZE=24 ZELOO_DESKTOP_DEV_SERVER=http://127.0.0.1:5174 \
...
node apps/desktop/scripts/profile-typing.mjs \
  --chars=400 --cps=30 --out=/tmp/Zeloo-typing
# → /tmp/Zeloo-typing.cpuprofile  (open in Chrome DevTools Performance)
# → /tmp/Zeloo-typing.before.heapsnapshot
# → /tmp/Zeloo-typing.after.heapsnapshot
```
