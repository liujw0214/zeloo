/**
 * Canonical Zeloo skin — the theme SDK's cross-surface contract.
 *
 * A skin is authored once as YAML in `$ZELOO_HOME/skins/<name>.yaml` (or a
 * built-in), resolved by the Python skin engine (`zeloo_cli/skin_engine.py`),
 ...
 *   • CLI     → `zeloo_cli/skin_engine` → prompt_toolkit / Rich styles (Python)
 *
