...
A host that runs a blocking command on a worker thread (Zeloo Console) never sees
...
_ACTIVE_SCOPE: ContextVar[Optional["InterruptScope"]] = ContextVar("zeloo_interrupt_scope", default=None)
