...
_SESSION_CWD: ContextVar = ContextVar("ZELOO_SESSION_CWD", default=_UNSET)
...
def resolve_context_cwd() -> Path | None:
    ...
    launch dir). An existing configured path is honored verbatim — including the Zeloo source tree, a
    legitimate workspace when developing Zeloo; fallback-directory policy lives in the caller."""
