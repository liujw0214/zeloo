...
def get_zeloo_home() -> Path:
    ...
    2. Legacy ``zeloo_HOME`` / ``zelooHOME`` variables
    3. Programmatic override (set_zeloo_home_override)
    4. Default ~/.Zeloo
    """
...
DEFAULT_CONTEXT_MAX_MESSAGES = 40
DEFAULT_CONTEXT_KEEP_RECENT = 10
DEFAULT_CONTEXT_SUMMARY_CHARS = 800
