...
class BitwardenLoginBackend(LoginBackend):
    ...
    def unlock(self, master_password: str) -> None:
        ...
        proc = run_with_secret_env([str(self._bw()), "unlock", "--raw", "--nointeraction", "--passwordenv", "ZELOO_BW_MASTER"],
                                   env=self._env(None), secret_env="ZELOO_BW_MASTER", secret=master_password,
