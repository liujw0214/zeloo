"""``Zeloo secrets`` subcommand parser."""
...
def build_secrets_parser(subparsers) -> None:
    ...
    secrets_parser = subparsers.add_parser(
        ...
        description="Pull API keys from an external secret manager at process startup "
            "instead of storing them in ~/.Zeloo/.env.  Supports Bitwarden "
            "Secrets Manager and 1Password.  See: "
            "https://Zeloo-agent.nousresearch.com/docs/user-guide/secrets/")
    ...
    from zeloo_cli import secrets_cli as _secrets_cli
    from zeloo_cli import onepassword_secrets_cli as _op_secrets_cli
