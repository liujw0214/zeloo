...
def build_gui_parser(subparsers, *, cmd_gui: Callable) -> None:
    ...
    gui_parser = subparsers.add_parser(
        ...
        description="Launch the Zeloo Electron desktop app. By default this installs "
    ...
    gui_parser.add_argument(
        ...
        help="Force Desktop to ignore any Zeloo CLI already on PATH during backend resolution")
    gui_parser.add_argument(
        "--Zeloo-root",
        help="Override the Zeloo source root used by Desktop (sets ZELOO_DESKTOP_ZELOO_ROOT)")
    gui_parser.add_argument(
        "--cwd",
        help="Initial project directory for Desktop chat sessions (sets ZELOO_DESKTOP_CWD)")
    gui_parser.add_argument(
    ...
    gui_parser.add_argument(
        "--identity", default="Zeloo Local Signing",
        help="Certificate name to create/use for --setup-tcc-identity (default: Zeloo Local Signing)",
    )
