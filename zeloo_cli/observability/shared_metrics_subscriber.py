"""Relay subscriber for the persisted Zeloo shared-metrics slice."""
...
class SharedMetricsSubscriber:
    """Persist validated Zeloo counters from Relay lifecycle events."""
    ...
    def __call__(self, event: Any) -> None:
        ...
        with self._lock:
            ...
            try:
                ...
                logger.warning(
                    "Unable to persist the Zeloo shared metric: %s", metric_name, exc_info=True
                )
