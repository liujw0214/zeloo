...
from zeloo_cli.dashboard_auth import prefix as _prefix_mod
from zeloo_cli.dashboard_auth.audit import AuditEvent, audit_log
from zeloo_cli.dashboard_auth.base import (
...
from zeloo_cli.dashboard_auth.cookies import (
    ...
    set_session_cookies)
from zeloo_cli.dashboard_auth.login_page import (
...
def _provider_pkce_segments(cookie_payload: dict[str, str]) -> dict[str, str]:
    ...
    flat = cookie_payload.get("zeloo_session_pkce", "")
...
async def api_auth_ws_ticket(request: Request):
    ...
    sess = _require_session(request)
    from zeloo_cli.dashboard_auth.ws_tickets import TTL_SECONDS, mint_ticket
