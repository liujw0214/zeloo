"""Single source of truth for provider identity in Zeloo Agent."""
...
# -- Zeloo overlay: metadata models.dev doesn't provide ----------------------

@dataclass(frozen=True)
class ZELOOOverlay:
    """Zeloo-specific provider metadata layered on top of models.dev."""
...
ZELOO_OVERLAYS: Dict[str, ZELOOOverlay] = {
    "moa": ZELOOOverlay(auth_type="virtual", base_url_override="moa://local"),
    "openrouter": ZELOOOverlay(is_aggregator=True, base_url_env_var="OPENROUTER_BASE_URL"),
    "nous": ZELOOOverlay(auth_type="oauth_device_code", base_url_override="https://inference-api.nousresearch.com/v1"),
    "openai-codex": ZELOOOverlay(transport="codex_responses", auth_type="oauth_external",
                                  base_url_override="https://chatgpt.com/backend-api/codex"),
    "openai-api": ZELOOOverlay(transport="codex_responses", base_url_override="https://api.openai.com/v1",
                                base_url_env_var="OPENAI_BASE_URL"),
    "xai-oauth": ZELOOOverlay(transport="codex_responses", auth_type="oauth_external",
                               base_url_override="https://api.x.ai/v1", base_url_env_var="XAI_BASE_URL"),
    "qwen-oauth": ZELOOOverlay(auth_type="oauth_external", base_url_override="https://portal.qwen.ai/v1",
                                base_url_env_var="ZELOO_QWEN_BASE_URL"),
    "lmstudio": ZELOOOverlay(extra_env_vars=("LM_API_KEY",), base_url_override="http://127.0.0.1:1234/v1",
                              base_url_env_var="LM_BASE_URL"),
    "copilot-acp": ZELOOOverlay(transport="codex_responses", auth_type="external_process",
                                 base_url_override="acp://copilot", base_url_env_var="COPILOT_ACP_BASE_URL"),
    "github-copilot": ZELOOOverlay(extra_env_vars=("COPILOT_GITHUB_TOKEN", "GH_TOKEN")),
    "anthropic": ZELOOOverlay(transport="anthropic_messages", extra_env_vars=("ANTHROPIC_TOKEN", "CLAUDE_CODE_OAUTH_TOKEN")),
    "zai": ZELOOOverlay(extra_env_vars=("GLM_API_KEY", "ZAI_API_KEY", "Z_AI_API_KEY"), base_url_env_var="GLM_BASE_URL"),
    "kimi-for-coding": ZELOOOverlay(base_url_env_var="KIMI_BASE_URL"),
    "stepfun": ZELOOOverlay(extra_env_vars=("STEPFUN_API_KEY",),
                             base_url_override="https://api.stepfun.ai/step_plan/v1",
                             base_url_env_var="STEPFUN_BASE_URL"),
    "minimax": ZELOOOverlay(transport="anthropic_messages", base_url_env_var="MINIMAX_BASE_URL"),
    "minimax-oauth": ZELOOOverlay(transport="anthropic_messages", auth_type="oauth_external",
                                   base_url_override="https://api.minimax.io/anthropic"),
    "minimax-cn": ZELOOOverlay(transport="anthropic_messages", base_url_env_var="MINIMAX_CN_BASE_URL"),
    "deepseek": ZELOOOverlay(base_url_env_var="DEEPSEEK_BASE_URL"),
    "alibaba": ZELOOOverlay(base_url_env_var="DASHSCOPE_BASE_URL"),
    "alibaba-coding-plan": ZELOOOverlay(base_url_env_var="ALIBABA_CODING_PLAN_BASE_URL"),
    "vercel": ZELOOOverlay(is_aggregator=True),
    "opencode": ZELOOOverlay(is_aggregator=True, base_url_env_var="OPENCODE_ZEN_BASE_URL"),
    "opencode-go": ZELOOOverlay(is_aggregator=True, base_url_env_var="OPENCODE_GO_BASE_URL"),
    "opencode-free": ZELOOOverlay(is_aggregator=True, base_url_override="https://opencode.ai/zen/v1", keyless=True),
    "kilo": ZELOOOverlay(is_aggregator=True, base_url_env_var="KILOCODE_BASE_URL"),
    "huggingface": ZELOOOverlay(is_aggregator=True, base_url_env_var="HF_BASE_URL"),
    "novita": ZELOOOverlay(is_aggregator=True, base_url_env_var="NOVITA_BASE_URL"),
    "xai": ZELOOOverlay(transport="codex_responses", base_url_override="https://api.x.ai/v1", base_url_env_var="XAI_BASE_URL"),
    "nvidia": ZELOOOverlay(base_url_override="https://integrate.api.nvidia.com/v1", base_url_env_var="NVIDIA_BASE_URL"),
    "xiaomi": ZELOOOverlay(base_url_env_var="XIAOMI_BASE_URL"),
    "tencent-tokenhub": ZELOOOverlay(base_url_env_var="TOKENHUB_BASE_URL"),
    "tencent-tokenplan": ZELOOOverlay(transport="anthropic_messages",
                                       base_url_override="https://api.lkeap.cloud.tencent.com/plan/anthropic",
                                       base_url_env_var="TOKENPLAN_BASE_URL"),
    "arcee": ZELOOOverlay(base_url_override="https://api.arcee.ai/api/v1", base_url_env_var="ARCEE_BASE_URL"),
    "gmi": ZELOOOverlay(extra_env_vars=("GMI_API_KEY",), base_url_override="https://api.gmi-serving.com/v1",
                         base_url_env_var="GMI_BASE_URL"),
    "fireworks": ZELOOOverlay(extra_env_vars=("FIREWORKS_API_KEY",),
                               base_url_override="https://api.fireworks.ai/inference/v1"),
    "actual": ZELOOOverlay(transport="chat_completions", extra_env_vars=("ACTUAL_API_KEY",),
                            base_url_override="https://api.actual.inc/v1", base_url_env_var="ACTUAL_BASE_URL"),
    "upstage": ZELOOOverlay(extra_env_vars=("UPSTAGE_API_KEY",), base_url_override="https://api.upstage.ai/v1",
                             base_url_env_var="UPSTAGE_BASE_URL"),
    "nebius-token-factory": ZELOOOverlay(extra_env_vars=("NEBIUS_API_KEY", "NEBIUS_TOKEN_FACTORY_API_KEY"),
                                          base_url_override="https://api.tokenfactory.nebius.com/v1",
                                          base_url_env_var="NEBIUS_BASE_URL"),
    "ollama-cloud": ZELOOOverlay(base_url_override="https://ollama.com/v1", base_url_env_var="OLLAMA_BASE_URL"),
    # Azure Foundry serves OpenAI- and Anthropic-style endpoints; transport comes from model.api_mode.
    "azure-foundry": ZELOOOverlay(base_url_env_var="AZURE_FOUNDRY_BASE_URL"),
    "bedrock": ZELOOOverlay(transport="bedrock_converse", auth_type="aws_sdk"),
    ...
    "vertex": ZELOOOverlay(auth_type="vertex"),
}
...
class ProviderDef:
    ...
    doc: str = ""
    source: str = ""                      # "models.dev", "Zeloo", "user-config"
...
def _overlay_pdef(canonical, ov: ZELOOOverlay, name, env_vars, base_url, doc, source) -> ProviderDef:
...
def get_provider(name: str, *, allow_network: bool = True) -> Optional[ProviderDef]:
    """Look up a built-in provider by id or alias: models.dev catalog merged with the Zeloo overlay;
    Zeloo-only overlay (nous, openai-codex, …); plugin provider profiles with a concrete endpoint."""
    canonical = normalize_provider(name)
    mdev_info = _models_dev_info(canonical, allow_network)
    overlay = ZELOO_OVERLAYS.get(canonical)
    if mdev_info is not None:
        ov = overlay or ZELOOOverlay()
    ...
    if overlay is not None:
        return _overlay_pdef(canonical, overlay, _LABEL_OVERRIDES.get(canonical, canonical), overlay.extra_env_vars,
                             overlay.base_url_override, "", "Zeloo")
    # Plugin-registered profiles (plugins/model-providers/<name>/) absent from models.dev and
    # ZELOO_OVERLAYS would otherwise be "Unknown provider" in /model, --provider and model-switch
...
def _lossy_alias_registry_pdef(raw: str, canonical: str) -> Optional[ProviderDef]:
    """Exact Zeloo registry ids win over LOSSY alias collapsing (kimi-coding-cn must stay distinct
    ...
    try:
        from zeloo_cli.auth import PROVIDER_REGISTRY as _AUTH_PROVIDER_REGISTRY
...
def _llamacpp_pdef() -> Optional[ProviderDef]:
    ...
    try:
        from zeloo_cli.local_runtime.endpoint import resolve_llamacpp_endpoint
