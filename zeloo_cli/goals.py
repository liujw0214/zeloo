"""Persistent session goals — the Ralph loop for Zeloo.
...
# (schema DDL, FTS tables, first zeloo_cli.config import) measures ~300ms warm and more on slow
...
def _get_session_db() -> Optional[Any]:
    """Cached SessionDB per ZELOO_HOME (profile switches pick the right DB); None on any failure.
