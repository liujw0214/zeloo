...
def run_whatsapp_cloud_setup() -> int:
    ...
    _lines(
        ...
        "This wizard configures Zeloo to talk to WhatsApp via Meta's",
    ...
    _lines(
        "", "  Zeloo needs a public HTTPS URL to receive WhatsApp messages.",
        ...
        "    3. Start the Zeloo gateway in another terminal:",
        "         Zeloo gateway", "",
    ...
    _lines(
        ...
        "  Docs: https://Zeloo-agent.nousresearch.com/docs/user-guide/",
