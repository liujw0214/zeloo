...
Pure leaf: imports nothing from ``zeloo_cli.auth`` so the per-provider modules
...
# httpx is imported lazily (~30ms) because zeloo_cli.auth is on the interactive-CLI startup path
...
if TYPE_CHECKING:
    ...
    class _LazyHttpx:
        ...
        # set/del forward to the real module so monkeypatch.setattr("zeloo_cli.auth.httpx.Client")
...
DEFAULT_NOUS_CLIENT_ID = "Zeloo-cli"
...
try:  # Version tag for the Codex token-endpoint User-Agent; fall back if unavailable.
    from zeloo_cli import __version__ as _ZELOO_CLI_VERSION
except Exception:  # pragma: no cover - version import should always succeed
    _ZELOO_CLI_VERSION = "unknown"
CODEX_OAUTH_USER_AGENT = f"Zeloo-cli/{_ZELOO_CLI_VERSION}"
...
SPOTIFY_DOCS_URL = "https://Zeloo-agent.nousresearch.com/docs/user-guide/features/spotify"
SPOTIFY_DASHBOARD_URL = "https://developer.spotify.com/dashboard"
SPOTIFY_ACCESS_TOKEN_REFRESH_SKEW_SECONDS = 120

OAUTH_OVER_SSH_DOCS_URL = "https://Zeloo-agent.nousresearch.com/docs/guides/oauth-over-ssh"
