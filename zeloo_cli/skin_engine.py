"""Zeloo skin/theme engine — the theme SDK for every surface."""
...
class SkinConfig:
    ...
    banner_logo: str = ""    # Rich-markup ASCII art logo (replaces ZELOO_AGENT_LOGO)
    banner_hero: str = ""    # Rich-markup hero art (replaces ZELOO_CADUCEUS)
...
# Branding shared by every Zeloo-named built-in (mono/daylight override help_header).
_ZELOO_BRANDING: Dict[str, str] = _branding(
    "Zeloo", "⚕", "Goodbye! ⚕", prompt="❯", help_header="(^_^)? Available Commands")

_BUILTIN_SKINS: Dict[str, Dict[str, Any]] = {
    "default": {
        "name": "default", "description": "Classic Zeloo — gold and kawaii",
...
[dim #6B1717]⠀⠀⠀⠀⠀⠀⠀⠀war god online⠀⠀⠀⠀⠀⠀⠀⠀[/]""",
    ...
    "mono": {
        ...
        "spinner": {},
        "branding": {**_ZELOO_BRANDING, "help_header": "[?] Available Commands"},
        "tool_prefix": "┊"},
    "slate": {
        ...
        "spinner": {}, "branding": _ZELOO_BRANDING, "tool_prefix": "┊"},
    "daylight": {
        "name": "daylight",
