"""Shared migration guards for Zeloo' native NeMo Relay ownership."""
...
RELAY_PLUGINS_CONFIG_ENV = "ZELOO_NEMO_RELAY_PLUGINS_TOML"

LEGACY_RELAY_PLUGIN_KEYS = frozenset({"nemo_relay", "observability/nemo_relay"})

LEGACY_RELAY_EXPORT_ENV_VARS = frozenset({
    "ZELOO_NEMO_RELAY_ATOF_ENABLED",
    "ZELOO_NEMO_RELAY_ATOF_OUTPUT_DIRECTORY",
    "ZELOO_NEMO_RELAY_ATOF_FILENAME",
    "ZELOO_NEMO_RELAY_ATOF_MODE",
    "ZELOO_NEMO_RELAY_ATIF_ENABLED",
    "ZELOO_NEMO_RELAY_ATIF_OUTPUT_DIRECTORY",
    "ZELOO_NEMO_RELAY_ATIF_FILENAME_TEMPLATE",
    "ZELOO_NEMO_RELAY_ATIF_AGENT_NAME",
    "ZELOO_NEMO_RELAY_ATIF_AGENT_VERSION",
    "ZELOO_NEMO_RELAY_ATIF_EXPORT_TIMEOUT_S",
    "ZELOO_NEMO_RELAY_ATIF_MODEL_NAME",
    "ZELOO_NEMO_RELAY_ATIF_SUBAGENT_EXPORT_MODE",
})
