...
def main() -> None:
    ...
    zeloo_home = Path(tempfile.mkdtemp(prefix="Zeloo-otel-smoke-"))
    ...
    config = {
        "monitoring": {
            ...
            "gateway_health_export": {
                ...
                "resource_attributes": {
                    "service.name": "Zeloo-gateway-smoke",
    ...
    print(json.dumps({"zeloo_home": str(zeloo_home), "requests": len(rows), "paths": sorted(paths)}, indent=2))
