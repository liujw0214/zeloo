...
DEFAULT_DATASETS = [
    ...
    "NousResearch/Zeloo-agent-megascience-sft1",
    "NousResearch/Zeloo-Agent-Thinking-GLM-4.7-SFT2",
    "NousResearch/Zeloo-Agent-Thinking-GLM-4.7-SFT1",
    "NousResearch/terminal-tasks-glm-Zeloo-agent"
]
