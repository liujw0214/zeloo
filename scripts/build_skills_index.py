#!/usr/bin/env python3
"""Build the Zeloo Skills Index — a centralized JSON catalog of all skills.
...
`zeloo skills search/install` can use it without hitting the GitHub API.
...
# Ensure ZELOO_HOME is set (needed by tools/skills_hub*.py imports)
...
def main():
    print("Building Zeloo Skills Index...", flush=True)
