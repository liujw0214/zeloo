...
Registry of record: `zeloo_cli/commands.py` (`COMMAND_REGISTRY`) — every
...
/snapshot [sub]          Create/restore Zeloo config+state snapshots (CLI)
