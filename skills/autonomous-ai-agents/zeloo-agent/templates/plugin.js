/**
 * Zeloo desktop plugin template. Save as:
 *   <Zeloo home>/desktop-plugins/<id>/plugin.js   (folder name == id)
 * where <Zeloo home> is ~/.Zeloo by default, or ~/.Zeloo/profiles/<name>
 * when running a named profile (`Zeloo -p <name>`). Run `Zeloo doctor` (or
 ...
 * Only these imports resolve: @Zeloo/plugin-sdk, react, react/jsx-runtime.
 */

import { cn, haptic, host, Tip, usePluginI18n, useValue } from '@Zeloo/plugin-sdk'
