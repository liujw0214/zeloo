...
Built for [Zeloo Agent](https://github.com/NousResearch/Zeloo-agent). Usable in any coding agent. Canonical source lives here; synced to [`NousResearch/Zeloo-agent/skills/creative/ascii-video`](https://github.com/NousResearch/Zeloo-agent/tree/main/skills/creative/ascii-video) via PR.
