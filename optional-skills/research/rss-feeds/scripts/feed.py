...
Standard library only, so it runs in any Zeloo environment without an install
...
USER_AGENT = "Zeloo-agent/1.0 (rss-feeds skill; +https://github.com/NousResearch/Zeloo-agent)"
TIMEOUT = 20
NS = {
