...
def _state_dir() -> Path:
    ...
    # Default: $ZELOO_HOME/watcher-state/, falling back to ~/.Zeloo/watcher-state/.
    zeloo_home = os.environ.get("ZELOO_HOME") or str(Path.home() / ".Zeloo")
    return Path(zeloo_home) / "watcher-state"
