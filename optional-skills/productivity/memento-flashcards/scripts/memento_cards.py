...
Data file: $ZELOO_HOME/skills/productivity/memento-flashcards/data/cards.json
"""
...
_ZELOO_HOME = Path(os.environ.get("ZELOO_HOME", Path.home() / ".Zeloo"))
DATA_DIR = _ZELOO_HOME / "skills" / "productivity" / "memento-flashcards" / "data"
