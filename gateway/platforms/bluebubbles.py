...
# `require_mention: true` without custom aliases uses Zeloo wake words.
DEFAULT_MENTION_PATTERNS = [r"(?<![\w@])@?Zeloo\s+agent\b[,:\-]?", r"(?<![\w@])@?Zeloo\b[,:\-]?"]
...
class BlueBubblesAdapter(BasePlatformAdapter):
    ...
    def _compile_mention_patterns(raw: Any) -> List[re.Pattern]:
        ...
        comma/newline-separated), or None (Zeloo defaults)."""
