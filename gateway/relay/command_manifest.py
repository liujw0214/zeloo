...
def build_relay_command_manifest() -> List[Dict[str, Any]]:
    ...
    return [
        ...
        _cmd("reset", "Reset your Zeloo session"),
        ...
        _cmd("status", "Show Zeloo session status"),
        _cmd("sethome", "Set this chat as the home channel"),
        _cmd("stop", "Stop the running Zeloo agent"),
        ...
        _cmd("update", "Update Zeloo Agent to the latest version"),
        _cmd("restart", "Gracefully restart the Zeloo gateway"),
        ...
        _cmd("thread", "Create a new thread and start a Zeloo session in it",
