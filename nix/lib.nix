      ...
      let
        ...
        excludedDirs =
          ...
          jsWorkspaceTopDirs ++ [
            ...
            "nix"
            # Skills are shipped via ZELOO_BUNDLED_SKILLS /
            # ZELOO_OPTIONAL_SKILLS (see Zeloo-agent.nix), not via the
            ...
            # __init__.py) shipped via symlinks + ZELOO_BUNDLED_LOCALES
            # / ZELOO_OPTIONAL_MCPS, not via the wheel. Excluding them
