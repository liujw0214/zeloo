...
description: "How the Zeloo Desktop app signs in to a gated gateway using your system browser and PKCE — no embedded webview, no session cookies"
---

# Desktop Native Sign-In (RFC 8252)

When the Zeloo Desktop app connects to a **gated gateway** (a hosted or
...
For Zeloo specifically, native sign-in means:
...
- [Run Zeloo with Nous Portal](./run-Zeloo-with-nous-portal.md)
