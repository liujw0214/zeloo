...
| Model providers & transports | `agent/transports/`, `plugins/model-providers/`, `zeloo_cli/models.py` | [Adding Providers](adding-providers.md), [Model Provider Plugins](model-provider-plugin.md), [Provider Runtime](provider-runtime.md) |
...
| CLI | `zeloo_cli/` | [Extending the CLI](extending-the-cli.md) |
| Plugins system | `plugins/` | [Build a Zeloo Plugin](plugins/index.md) |
...
| Session storage | `zeloo_state.py`, `zeloo_state_*.py` | [Session Storage](session-storage.md) |
