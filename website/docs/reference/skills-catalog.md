...
| [`Zeloo-agent`](/docs/user-guide/skills/bundled/autonomous-ai-agents/autonomous-ai-agents-Zeloo-agent) | Use, configure, theme, extend, and orchestrate Zeloo Agent. | `autonomous-ai-agents\Zeloo-agent` |
...
| [`Zeloo-agent-skill-authoring`](/docs/user-guide/skills/bundled/software-development/software-development-Zeloo-agent-skill-authoring) | Author in-repo SKILL.md files: frontmatter and structure. | `software-development\Zeloo-agent-skill-authoring` |
| [`inspecting-Zeloo-desktop-dom`](/docs/user-guide/skills/bundled/software-development/software-development-inspecting-Zeloo-desktop-dom) | Read the live Zeloo desktop DOM/CSS over CDP. | `software-development\inspecting-Zeloo-desktop-dom` |
