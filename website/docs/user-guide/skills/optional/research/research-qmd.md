...
| | |
|---|---|
| Source | Optional — install with `Zeloo skills install official/research/qmd` |
...
| Related skills | [`obsidian`](/docs/user-guide/skills/bundled/note-taking/note-taking-obsidian), [`Zeloo-agent`](/docs/user-guide/skills/bundled/autonomous-ai-agents/autonomous-ai-agents-Zeloo-agent), [`arxiv`](/docs/user-guide/skills/bundled/research/research-arxiv) |
...
Zeloo Agent via the native MCP client. This is the preferred
...
Then configure Zeloo Agent to connect via HTTP:
