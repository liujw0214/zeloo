...
| | |
|---|---|
| Source | Optional — install with `Zeloo skills install official/research/blogwatcher` |
...
## Working with Zeloo tools (read this first)

`blogwatcher-cli` is the feed database; Zeloo tools do the automation around it:
