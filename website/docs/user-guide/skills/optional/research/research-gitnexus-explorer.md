...
| | |
|---|---|
| Source | Optional — install with `Zeloo skills install official/research/gitnexus-explorer` |
...
| Related skills | [`Zeloo-agent`](/docs/user-guide/skills/bundled/autonomous-ai-agents/autonomous-ai-agents-Zeloo-agent), [`codebase-inspection`](/docs/user-guide/skills/bundled/software-development/software-development-codebase-inspection) |
