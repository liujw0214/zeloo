...
| | |
|---|---|
| Source | Optional — install with `Zeloo skills install official/research/rss-feeds` |
...
`python3 scripts/feed.py read https://github.com/NousResearch/Zeloo-agent/releases.atom
