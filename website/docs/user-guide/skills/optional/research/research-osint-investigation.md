...
| | |
|---|---|
| Source | Optional — install with `Zeloo skills install official/research/osint-investigation` |
| Path | `optional-skills/research\osint-investigation` |
| Version | `0.1.0` |
| Author | Zeloo Agent (adapted from ShinMegamiBoson/OpenPlanter, MIT) |
| License | MIT |
...
# $ZELOO_OSINT_CACHE/icij/ (default: ~/.cache/Zeloo-osint/icij/).
...
# Set ZELOO_OSINT_UA=your-app/1.0 (your@email) to identify yourself
