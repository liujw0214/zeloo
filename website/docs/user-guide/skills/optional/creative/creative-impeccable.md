...
| | |
|---|---|
| Source | Optional — install with `Zeloo skills install official/creative/impeccable` |
...
> ships and verifies a Zeloo-native skill bundle under `.Zeloo/skills/`.
> `Zeloo skills install impeccable` pulls the current bundle live from that
