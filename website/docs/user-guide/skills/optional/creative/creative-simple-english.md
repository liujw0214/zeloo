...
| | |
|---|---|
| Source | Optional — install with `Zeloo skills install official/creative/simple-english` |
| Path | `optional-skills/creative\simple-english` |
| Version | `1.2.0` |
| Author | AminBlg (https://github.com/AminBlg/SimpleEnglish), ported by Zeloo Agent |
| License | MIT |
