...
| | |
|---|---|
| Source | Optional — install with `Zeloo skills install official/finance/stocks` |
| Path | `optional-skills/finance\stocks` |
| Version | `0.1.0` |
| Author | Mibay (Mibayy), Zeloo Agent |
| License | MIT |
...
```
SCRIPT=~/.Zeloo/skills/finance/stocks/scripts/stocks_client.py
...
```
python ~/.Zeloo/skills/finance/stocks/scripts/stocks_client.py quote AAPL
```
