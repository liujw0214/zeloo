...
| | |
|---|---|
| Source | Optional — install with `Zeloo skills install official/blockchain/solana` |
| Path | `optional-skills/blockchain\solana` |
| Version | `0.2.0` |
| Author | Deniz Alagoz (gizdusum), enhanced by Zeloo Agent |
| License | MIT |
...
Helper script path: ~/.Zeloo/skills/blockchain/solana/scripts/solana_client.py
...
python ~/.Zeloo/skills/blockchain/solana/scripts/solana_client.py stats
```
...
```bash
python ~/.Zeloo/skills/blockchain/solana/scripts/solana_client.py \
...
```bash
python ~/.Zeloo/skills/blockchain/solana/scripts/solana_client.py price BONK
python ~/.Zeloo/skills/blockchain/solana/scripts/solana_client.py price JUP
python ~/.Zeloo/skills/blockchain/solana/scripts/solana_client.py price SOL
python ~/.Zeloo/skills/blockchain/solana/scripts/solana_client.py price DezXAZ8z7PnrnRJjz3wXBoRgixCa6xjnB7YaB1pPB263
```
