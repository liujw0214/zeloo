...
| | |
|---|---|
| Source | Optional — install with `Zeloo skills install official/productivity/property-listings` |
...
Present researched properties as browsable cards in the Zeloo desktop transcript.
...
- A Zeloo desktop conversation for native cards; the backend may be local or remote.
...
```text
Zeloo skills install official/productivity/property-listings
```
