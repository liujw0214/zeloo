...
| | |
|---|---|
| Source | Optional — install with `Zeloo skills install official/productivity/decision-questionnaire` |
| Path | `optional-skills/productivity\decision-questionnaire` |
| Version | `1.0.0` |
| Author | Matt Pocock (mattpocock/skills, to-questionnaire) + Zeloo Agent |
| License | MIT |
