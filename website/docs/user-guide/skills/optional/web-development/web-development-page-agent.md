...
| | |
|---|---|
| Source | Optional — install with `Zeloo skills install official/web-development/page-agent` |
...
- User wants **Zeloo itself to drive a browser** → use Zeloo' built-in browser tool (Browserbase / Camofox). page-agent is the *opposite* direction.
