...
| | |
|---|---|
| Source | Optional — install with `Zeloo skills install official/data-science/jupyter-notebook` |
...
| `execute_code` | One-shot scripts needing Zeloo tool access (web_search, file ops). Stateless. |
