...
| | |
|---|---|
| Source | Optional — install with `Zeloo skills install official/health/neuroskill-bci` |
...
Connect Zeloo to a running [NeuroSkill](https://neuroskill.com/) instance to read
