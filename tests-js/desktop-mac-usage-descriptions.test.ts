 ...
 *
 * Each entry is a key/value pair that lands in the packaged Zeloo.app's
 ...
 * "Zeloo wants to access Music" prompt unless the Info.plist disclaims it
 ...
 * user ("Zeloo wants to access Music" when Zeloo never touches the Music
