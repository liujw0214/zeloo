 ...
 *
 * Symptom: in `Zeloo --tui`, typing into the composer until the input
 ...
 */
import { wrapAnsi } from '@Zeloo/ink'
...
const USER_REPORT_MESSAGE =
  ...
  'im in cursor terminal using Zeloo --tui and as i type multiline my caret at the end will often ' +
