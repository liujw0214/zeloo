import { Box, type ScrollBoxHandle, stringWidth, Text } from '@Zeloo/ink'
...
export function StatusRule({
  ...
  // Dev-only readout (ZELOO_DEV_CREDITS). The server omits the key entirely unless the
  ...
  // Dev-gated readout (ZELOO_DEV_CREDITS), lowest priority,
