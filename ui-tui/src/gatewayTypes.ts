import type { BillingBlock, UsageModelData } from '@Zeloo/shared/billing'
import type { ZELOOSkin } from '@Zeloo/shared/skin'

import type { SessionInfo, SlashCategory, SubagentStatus, Usage } from './types.js'

/** The cross-surface skin contract (canonical shape in `@Zeloo/shared`).
 *  Includes the paired light_colors/dark_colors overlays from #20379. */
export type GatewaySkin = ZELOOSkin
...
// Wire shapes now live in @Zeloo/shared for reuse by TypeScript clients.
export type {
  BillingAutoReload,
  BillingBlock,
  BillingCardInfo,
