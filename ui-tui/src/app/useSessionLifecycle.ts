...
import type { ScrollBoxHandle } from '@Zeloo/ink'
import { evictInkCaches } from '@Zeloo/ink'
...
export const writeActiveSessionFile = (sessionId: null | string, file = process.env.ZELOO_TUI_ACTIVE_SESSION_FILE) => {
  if (!file || !sessionId) {
    return
  }
