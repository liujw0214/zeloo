...
await build({
  ...
  // Skip the prebuilt @zeloo/ink bundle and inline the source instead:
  ...
  alias: { '@zeloo/ink': resolve(root, 'packages/zeloo-ink/src/entry-exports.ts') },
...
// the `node` token, leaving a broken interpreter). The zeloo_cli launcher
