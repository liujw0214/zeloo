 ...
 * across theme x background scenes to <tmpdir>/Zeloo-tui-visual/tui-visual.html,
...
import { Box, renderSync, Text } from '@Zeloo/ink'
...
// The regenerated slate light_colors block from zeloo_cli/skin_engine.py
// (relight recipe: vivid hue-preserved accents, airy capped-saturation text,
// darker calm dims).

const info: SessionInfo = {
  cwd: '/Users/brooklyn/www/Zeloo-agent',
...
const setup = (bgHex: string) => {
  process.env.ZELOO_TUI_BACKGROUND = bgHex
  resetOverlayState()
  resetUiState()
}
