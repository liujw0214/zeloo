 ...
 *
 * Plugins call window.__ZELOO_PLUGINS__.register(name, Component)
 ...
 * Exposed at runtime as ``window.__ZELOO_PLUGIN_SDK__.sdkVersion`` so a
...
export function exposePluginSDK() {
  ...
  window.__ZELOO_PLUGIN_SDK__ = {
    ...
    // window.__ZELOO_SESSION_TOKEN__ directly.
    authedFetch,
