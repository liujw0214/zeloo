 ...
 * `window.__ZELOO_PLUGINS__.registerSlot(pluginName, slotName, Component)`
 ...
 *  - `header-left`      — injected before the Zeloo brand in the top bar
 ...
 *  `window.__ZELOO_PLUGINS__.registerSlot(...)`.
 *
