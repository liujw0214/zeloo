...
export const en: Translations = {
  ...
  status: {
    ...
    updateZELOOConfirmMessage:
      "This runs Zeloo update and restarts the gateway when it finishes. Active sessions keep their prompt cache until then.",
    updateZELOOConfirmNow: "Update now",
    updateZELOOConfirmTitle: "Update Zeloo?",
    updatingZELOO: "Updating Zeloo…",
  ...
  pluginsPage: {
    ...
    headline:
      "Discover, install, enable, and update Zeloo plugins (`Zeloo plugins` parity).",
    ...
    removeConfirm: "Remove this plugin from ~/.Zeloo/plugins/?",
    removeHint: "Only user-installed plugins under ~/.Zeloo/plugins can be removed.",
    ...
    catalogEmptyDocsLink: "Learn about Zeloo plugins",
  ...
  skills: {
    ...
    filters: "Filters",
    noSkills: "No skills found. Skills are loaded from ~/.Zeloo/skills/",
  ...
  env: {
    ...
    customHint: "Arbitrary environment variables stored in your .env that Zeloo doesn't recognise. Use these to inject env vars for skills, MCP servers, or your own tooling.",
  ...
  achievements: {
    hero: {
      ...
      title: "Zeloo Achievements",
      subtitle:
        "Collectible Zeloo badges earned from real session history. Known unfinished achievements are shown as Discovered; Secret achievements stay hidden until the first matching behavior appears.",
      scan_subtitle:
        "Scanning Zeloo session history. First scan can take 5–10 seconds on large histories.",
    },
    actions: {
      rescan: "Rescan",
    },
    stats: {
      ...
      latest: "Latest",
      latest_hint_empty: "run Zeloo more",
      none_yet: "None yet",
    },
    state: {
      unlocked: "Unlocked",
    ...
    guide: {
      ...
      secret_body:
        "Secrets hide their exact trigger. Once Zeloo sees a related signal, the card becomes Discovered and shows its requirement.",
      scan_status_header: "Scan status",
      scan_status_body:
        "Zeloo is scanning local history once, then cards will appear automatically. Nothing is stuck if this takes a few seconds.",
    ...
    share: {
      ...
      tweet_text: "Just unlocked {tier_part}\"{name}\" in Zeloo Agent ☤",
    },
  },
