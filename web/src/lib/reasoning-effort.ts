 ...
 *
 * Values mirror zeloo_constants.VALID_REASONING_EFFORTS plus `none`
 * (thinking-off). An empty/unset config value means the Zeloo default,
 * which is `medium`.
 */
 ...
 *  option. Empty/unknown → `medium` (Zeloo' default when unset). */
