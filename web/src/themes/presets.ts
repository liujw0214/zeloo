 ...
 * `_BUILTIN_DASHBOARD_THEMES` list in `zeloo_cli/web_server.py`.
 */
...
export const defaultTheme: DashboardTheme = {
  name: "default",
  label: "Zeloo Teal",
  description: "Classic dark teal — the canonical Zeloo look",
  palette: {
...
export const defaultLargeTheme: DashboardTheme = {
  name: "default-large",
  label: "Zeloo Teal (Large)",
  description: "Zeloo Teal with bigger fonts and roomier spacing",
