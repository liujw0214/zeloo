...
const STORAGE_KEY = "Zeloo-dashboard-theme";
...
const FONT_STORAGE_KEY = "Zeloo-dashboard-font";
 ...
 *  `_THEME_NAMED_ASSET_KEYS` in `zeloo_cli/web_server.py`. */
...
const CUSTOM_CSS_STYLE_ID = "Zeloo-theme-custom-css";
...
function applyCustomCSS(css: string | undefined) {
  ...
  if (!el) {
    ...
    el.setAttribute("data-Zeloo-theme-css", "true");
...
function injectFontStylesheet(url: string | undefined) {
  ...
  link.rel = "stylesheet";
  link.href = url;
  link.setAttribute("data-Zeloo-theme-font", "true");
