...
const SOURCE_CONFIG: Record<string, { icon: typeof Terminal; color: string }> =
  {
    ...
    zeloo_flow: { icon: Play, color: "text-warning" },
...
const NO_MATCHING_SESSION_SOURCE = "__zeloo_dashboard_no_matching_source__";
        ...
        const res = await fetch(api.exportSessionUrl(id, rowProfile(id)), {
          ...
          headers: {
            "X-Zeloo-Session-Token":
              (window as unknown as { __ZELOO_SESSION_TOKEN__?: string })
                .__ZELOO_SESSION_TOKEN__ ?? "",
          },
        });
