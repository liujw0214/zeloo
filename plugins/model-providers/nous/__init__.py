...
class NousProfile(ProviderProfile):
    ...
    def _cannot_disable_reasoning(model: str | None) -> bool:
        ...
        try:
            from zeloo_cli.models_reasoning_caps import nous_model_reasoning_capabilities, warm_nous_reasoning_caps_async
...
nous = NousProfile(
    ...
    display_name="Nous Research", description="Nous Research — Zeloo model family",
    signup_url="https://nousresearch.com/", fallback_models=("Zeloo-3-405b", "Zeloo-3-70b"),
