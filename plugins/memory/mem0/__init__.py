...
self-hosted Mem0 server (MEM0_HOST, HTTP), or OSS Memory. Secrets live in $ZELOO_HOME/.env
(MEM0_API_KEY, MEM0_HOST); settings in $ZELOO_HOME/mem0.json via `Zeloo memory setup`:
...
def _load_config() -> dict:
    """Env vars provide defaults; $ZELOO_HOME/mem0.json overrides individual keys.
    ...
    config = {"mode": _scoped_env("MEM0_MODE") or "platform", "host": _scoped_env("MEM0_HOST"),
              "agent_id": _scoped_env("MEM0_AGENT_ID") or "Zeloo", "oss": {}}
    ...
    file_cfg = _read_mem0_json(get_zeloo_home() / "mem0.json")
...
class Mem0MemoryProvider(MemoryProvider):
    ...
    def __init__(self):
        ...
        self._mode, self._api_key, self._host, self._user_id, self._agent_id = "platform", "", "", _DEFAULT_USER_ID, "Zeloo"
    ...
    def save_config(self, values, zeloo_home):
        """Merge-write config to $ZELOO_HOME/mem0.json."""
        from utils import atomic_json_write
        config_path = Path(zeloo_home) / "mem0.json"
    ...
    def get_config_schema(self):
        ...
        return [
            ...
            {"key": "user_id", "description": "User identifier", "default": "Zeloo-user"},
            {"key": "agent_id", "description": "Agent identifier", "default": "Zeloo"},
            {"key": "rerank", "description": "Enable reranking for recall", "default": "false", "choices": ["true", "false"]},
        ]

    def post_setup(self, zeloo_home: str, config: dict) -> None:
        from ._setup import post_setup
        post_setup(zeloo_home, config)
    ...
    def initialize(self, session_id: str, **kwargs) -> None:
        ...
        self._mode, self._api_key, self._host, self._agent_id = cfg.get("mode", "platform"), cfg.get("api_key", ""), cfg.get("host", ""), cfg.get("agent_id", "Zeloo")
