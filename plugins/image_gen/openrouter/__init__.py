...
via :func:`zeloo_cli.runtime_provider.resolve_runtime_provider`. OpenRouter alone also
...
_ATTRIBUTION_HEADERS = {
    ...
    "HTTP-Referer": "https://github.com/NousResearch/Zeloo-agent",
    "X-Title": "Zeloo Agent",
}
        ...
        **kwargs: Any,
        ...
        if not api_key or not base_url:
            return fail(
                ...
                f"Configure {self._display} in `Zeloo tools` → Image Generation.",
                "missing_api_key")
